...
def cuahsihisskcmilltownids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisskcmilltownids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisskcmilltownids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisskcmilltownids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisskcmilltownids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisskcmilltownids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisskcmilltownids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisskcmilltownids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisskcmilltownids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisskcmilltownids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisskcmilltownids0():
    ...
    load1 = cuahsihisskcmilltownids0_nabu(harvest)
    load2 = cuahsihisskcmilltownids0_nabuprov(load1)
    load3 = cuahsihisskcmilltownids0_nabuorg(load2)
    load4 = cuahsihisskcmilltownids0_naburelease(load3)
