...
def hu020_gleaner(context):
    returned_value = gleanerio(("gleaner"), "hu020")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def hu020_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "hu020")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu020_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "hu020")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu020_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "hu020")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu020_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "hu020")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_hu020():
    ...
    load1 = hu020_nabu(harvest)
    load2 = hu020_nabuprov(load1)
    load3 = hu020_nabuorg(load2)
    load4 = hu020_naburelease(load3)
