...
def nwisgw1_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw1")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw1_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw1_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw1_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw1_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw1():
    ...
    load1 = nwisgw1_nabu(harvest)
    load2 = nwisgw1_nabuprov(load1)
    load3 = nwisgw1_nabuorg(load2)
    load4 = nwisgw1_naburelease(load3)
