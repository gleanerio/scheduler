...
def rise0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "rise0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def rise0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "rise0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def rise0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "rise0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def rise0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "rise0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def rise0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "rise0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_rise0():
    ...
    load1 = rise0_nabu(harvest)
    load2 = rise0_nabuprov(load1)
    load3 = rise0_nabuorg(load2)
    load4 = rise0_naburelease(load3)
