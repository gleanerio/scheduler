...
def refgage0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "refgage0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def refgage0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "refgage0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def refgage0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "refgage0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def refgage0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "refgage0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def refgage0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "refgage0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_refgage0():
    ...
    load1 = refgage0_nabu(harvest)
    load2 = refgage0_nabuprov(load1)
    load3 = refgage0_nabuorg(load2)
    load4 = refgage0_naburelease(load3)
