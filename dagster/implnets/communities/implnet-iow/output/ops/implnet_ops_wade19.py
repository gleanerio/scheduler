...
def wade19_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade19")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade19_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade19")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade19_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade19")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade19_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade19")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade19_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade19")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade19():
    ...
    load1 = wade19_nabu(harvest)
    load2 = wade19_nabuprov(load1)
    load3 = wade19_nabuorg(load2)
    load4 = wade19_naburelease(load3)
