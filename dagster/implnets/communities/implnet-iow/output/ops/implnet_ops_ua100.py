...
def ua100_gleaner(context):
    returned_value = gleanerio(("gleaner"), "ua100")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def ua100_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "ua100")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def ua100_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "ua100")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def ua100_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "ua100")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def ua100_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "ua100")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_ua100():
    ...
    load1 = ua100_nabu(harvest)
    load2 = ua100_nabuprov(load1)
    load3 = ua100_nabuorg(load2)
    load4 = ua100_naburelease(load3)
