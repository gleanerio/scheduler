...
def cuahsihisczoboulderids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisczoboulderids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisczoboulderids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisczoboulderids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczoboulderids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisczoboulderids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczoboulderids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisczoboulderids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczoboulderids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisczoboulderids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisczoboulderids0():
    ...
    load1 = cuahsihisczoboulderids0_nabu(harvest)
    load2 = cuahsihisczoboulderids0_nabuprov(load1)
    load3 = cuahsihisczoboulderids0_nabuorg(load2)
    load4 = cuahsihisczoboulderids0_naburelease(load3)
