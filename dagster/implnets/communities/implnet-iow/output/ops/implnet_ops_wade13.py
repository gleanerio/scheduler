...
def wade13_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade13")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade13_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade13")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade13_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade13")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade13_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade13")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade13_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade13")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade13():
    ...
    load1 = wade13_nabu(harvest)
    load2 = wade13_nabuprov(load1)
    load3 = wade13_nabuorg(load2)
    load4 = wade13_naburelease(load3)
