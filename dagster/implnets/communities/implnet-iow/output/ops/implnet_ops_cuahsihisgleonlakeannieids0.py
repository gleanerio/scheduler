...
def cuahsihisgleonlakeannieids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisgleonlakeannieids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisgleonlakeannieids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisgleonlakeannieids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonlakeannieids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisgleonlakeannieids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonlakeannieids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisgleonlakeannieids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonlakeannieids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisgleonlakeannieids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisgleonlakeannieids0():
    ...
    load1 = cuahsihisgleonlakeannieids0_nabu(harvest)
    load2 = cuahsihisgleonlakeannieids0_nabuprov(load1)
    load3 = cuahsihisgleonlakeannieids0_nabuorg(load2)
    load4 = cuahsihisgleonlakeannieids0_naburelease(load3)
