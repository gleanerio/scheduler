...
def nwisgw26_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw26")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw26_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw26")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw26_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw26")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw26_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw26")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw26_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw26")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw26():
    ...
    load1 = nwisgw26_nabu(harvest)
    load2 = nwisgw26_nabuprov(load1)
    load3 = nwisgw26_nabuorg(load2)
    load4 = nwisgw26_naburelease(load3)
