...
def cuahsihisdrwiids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisdrwiids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisdrwiids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisdrwiids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisdrwiids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisdrwiids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisdrwiids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisdrwiids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisdrwiids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisdrwiids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisdrwiids0():
    ...
    load1 = cuahsihisdrwiids0_nabu(harvest)
    load2 = cuahsihisdrwiids0_nabuprov(load1)
    load3 = cuahsihisdrwiids0_nabuorg(load2)
    load4 = cuahsihisdrwiids0_naburelease(load3)
