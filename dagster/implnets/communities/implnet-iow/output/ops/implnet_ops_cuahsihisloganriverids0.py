...
def cuahsihisloganriverids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisloganriverids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisloganriverids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisloganriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisloganriverids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisloganriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisloganriverids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisloganriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisloganriverids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisloganriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisloganriverids0():
    ...
    load1 = cuahsihisloganriverids0_nabu(harvest)
    load2 = cuahsihisloganriverids0_nabuprov(load1)
    load3 = cuahsihisloganriverids0_nabuorg(load2)
    load4 = cuahsihisloganriverids0_naburelease(load3)
