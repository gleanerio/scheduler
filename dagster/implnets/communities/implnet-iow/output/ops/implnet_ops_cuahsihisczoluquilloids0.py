...
def cuahsihisczoluquilloids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisczoluquilloids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisczoluquilloids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisczoluquilloids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczoluquilloids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisczoluquilloids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczoluquilloids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisczoluquilloids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczoluquilloids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisczoluquilloids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisczoluquilloids0():
    ...
    load1 = cuahsihisczoluquilloids0_nabu(harvest)
    load2 = cuahsihisczoluquilloids0_nabuprov(load1)
    load3 = cuahsihisczoluquilloids0_nabuorg(load2)
    load4 = cuahsihisczoluquilloids0_naburelease(load3)
