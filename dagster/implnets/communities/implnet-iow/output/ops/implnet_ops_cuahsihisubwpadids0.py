...
def cuahsihisubwpadids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisubwpadids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisubwpadids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisubwpadids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisubwpadids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisubwpadids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisubwpadids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisubwpadids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisubwpadids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisubwpadids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisubwpadids0():
    ...
    load1 = cuahsihisubwpadids0_nabu(harvest)
    load2 = cuahsihisubwpadids0_nabuprov(load1)
    load3 = cuahsihisubwpadids0_nabuorg(load2)
    load4 = cuahsihisubwpadids0_naburelease(load3)
