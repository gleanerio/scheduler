...
@schedule(cron_schedule="0 8 8 * *", job=implnet_job_cuahsihisyosemitehydroclimatenetworkids0, default_status=DefaultScheduleStatus.RUNNING, execution_timezone="US/Central")
