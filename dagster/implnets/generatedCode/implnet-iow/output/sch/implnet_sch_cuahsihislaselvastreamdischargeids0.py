...
@schedule(cron_schedule="0 12 5 * *", job=implnet_job_cuahsihislaselvastreamdischargeids0, default_status=DefaultScheduleStatus.RUNNING, execution_timezone="US/Central")
