...
@schedule(cron_schedule="0 8 7 * *", job=implnet_job_cuahsihisnooksackmicroclimatenetworkids0, default_status=DefaultScheduleStatus.RUNNING, execution_timezone="US/Central")
