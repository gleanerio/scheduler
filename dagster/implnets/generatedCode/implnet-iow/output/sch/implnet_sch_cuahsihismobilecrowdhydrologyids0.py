...
@schedule(cron_schedule="0 4 16 * *", job=implnet_job_cuahsihismobilecrowdhydrologyids0, default_status=DefaultScheduleStatus.RUNNING, execution_timezone="US/Central")
