...
@schedule(cron_schedule="0 14 6 * *", job=implnet_job_cuahsihisredbuttecreekgamutids0, default_status=DefaultScheduleStatus.RUNNING, execution_timezone="US/Central")
