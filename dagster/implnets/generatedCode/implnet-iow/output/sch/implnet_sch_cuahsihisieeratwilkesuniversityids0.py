...
@schedule(cron_schedule="0 12 2 * *", job=implnet_job_cuahsihisieeratwilkesuniversityids0, default_status=DefaultScheduleStatus.RUNNING, execution_timezone="US/Central")
