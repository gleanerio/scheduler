...
@schedule(cron_schedule="0 16 7 * *", job=implnet_job_cuahsihisglobalriversobservatoryids0, default_status=DefaultScheduleStatus.RUNNING, execution_timezone="US/Central")
