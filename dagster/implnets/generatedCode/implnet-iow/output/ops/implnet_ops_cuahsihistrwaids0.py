...
def cuahsihistrwaids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihistrwaids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihistrwaids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihistrwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihistrwaids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihistrwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihistrwaids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihistrwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihistrwaids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihistrwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihistrwaids0():
    ...
    load1 = cuahsihistrwaids0_nabu(harvest)
    load2 = cuahsihistrwaids0_nabuprov(load1)
    load3 = cuahsihistrwaids0_nabuorg(load2)
    load4 = cuahsihistrwaids0_naburelease(load3)
