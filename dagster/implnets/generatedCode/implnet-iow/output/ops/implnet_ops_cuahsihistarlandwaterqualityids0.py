...
def cuahsihistarlandwaterqualityids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihistarlandwaterqualityids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihistarlandwaterqualityids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihistarlandwaterqualityids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihistarlandwaterqualityids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihistarlandwaterqualityids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihistarlandwaterqualityids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihistarlandwaterqualityids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihistarlandwaterqualityids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihistarlandwaterqualityids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihistarlandwaterqualityids0():
    ...
    load1 = cuahsihistarlandwaterqualityids0_nabu(harvest)
    load2 = cuahsihistarlandwaterqualityids0_nabuprov(load1)
    load3 = cuahsihistarlandwaterqualityids0_nabuorg(load2)
    load4 = cuahsihistarlandwaterqualityids0_naburelease(load3)
