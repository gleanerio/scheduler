...
def cuahsihisumbcgwids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisumbcgwids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisumbcgwids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisumbcgwids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisumbcgwids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisumbcgwids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisumbcgwids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisumbcgwids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisumbcgwids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisumbcgwids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisumbcgwids0():
    ...
    load1 = cuahsihisumbcgwids0_nabu(harvest)
    load2 = cuahsihisumbcgwids0_nabuprov(load1)
    load3 = cuahsihisumbcgwids0_nabuorg(load2)
    load4 = cuahsihisumbcgwids0_naburelease(load3)
