...
def cuahsihisirwaids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisirwaids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisirwaids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisirwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisirwaids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisirwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisirwaids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisirwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisirwaids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisirwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisirwaids0():
    ...
    load1 = cuahsihisirwaids0_nabu(harvest)
    load2 = cuahsihisirwaids0_nabuprov(load1)
    load3 = cuahsihisirwaids0_nabuorg(load2)
    load4 = cuahsihisirwaids0_naburelease(load3)
