...
@op
def cuahsihisgleonlakeannieids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihisgleonlakeannieids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonlakeannieids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihisgleonlakeannieids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonlakeannieids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihisgleonlakeannieids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonlakeannieids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihisgleonlakeannieids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihisgleonlakeannieids0_uploadrelease(context, msg: str):
...
@op
def cuahsihisgleonlakeannieids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisgleonlakeannieids0")
    ...
    return msg + r
@op
def cuahsihisgleonlakeannieids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisgleonlakeannieids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihisgleonlakeannieids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisgleonlakeannieids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihisgleonlakeannieids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisgleonlakeannieids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisgleonlakeannieids0"
...
def cuahsihisgleonlakeannieids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisgleonlakeannieids0"
...
def harvest_cuahsihisgleonlakeannieids0():
    harvest = cuahsihisgleonlakeannieids0_gleaner()

    report_ms3 = cuahsihisgleonlakeannieids0_missingreport_s3(harvest)
    report_idstat = cuahsihisgleonlakeannieids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihisgleonlakeannieids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihisgleonlakeannieids0")
    load_release = cuahsihisgleonlakeannieids0_naburelease(harvest)
    load_uploadrelease = cuahsihisgleonlakeannieids0_uploadrelease(load_release)

    load_prune = cuahsihisgleonlakeannieids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihisgleonlakeannieids0_nabuprov(load_prune)
    load_org = cuahsihisgleonlakeannieids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihisgleonlakeannieids0_missingreport_graph(load_org)
    report_graph=cuahsihisgleonlakeannieids0_graph_reports(report_msgraph)
