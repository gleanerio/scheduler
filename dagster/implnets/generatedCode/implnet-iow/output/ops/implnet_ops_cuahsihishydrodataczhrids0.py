...
def cuahsihishydrodataczhrids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihishydrodataczhrids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihishydrodataczhrids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihishydrodataczhrids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihishydrodataczhrids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihishydrodataczhrids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihishydrodataczhrids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihishydrodataczhrids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihishydrodataczhrids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihishydrodataczhrids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihishydrodataczhrids0():
    ...
    load1 = cuahsihishydrodataczhrids0_nabu(harvest)
    load2 = cuahsihishydrodataczhrids0_nabuprov(load1)
    load3 = cuahsihishydrodataczhrids0_nabuorg(load2)
    load4 = cuahsihishydrodataczhrids0_naburelease(load3)
