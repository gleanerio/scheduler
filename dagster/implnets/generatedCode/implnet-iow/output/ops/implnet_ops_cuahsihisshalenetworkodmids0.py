...
def cuahsihisshalenetworkodmids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisshalenetworkodmids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisshalenetworkodmids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisshalenetworkodmids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisshalenetworkodmids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisshalenetworkodmids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisshalenetworkodmids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisshalenetworkodmids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisshalenetworkodmids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisshalenetworkodmids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisshalenetworkodmids0():
    ...
    load1 = cuahsihisshalenetworkodmids0_nabu(harvest)
    load2 = cuahsihisshalenetworkodmids0_nabuprov(load1)
    load3 = cuahsihisshalenetworkodmids0_nabuorg(load2)
    load4 = cuahsihisshalenetworkodmids0_naburelease(load3)
