...
def wade11_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade11")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade11_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade11")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade11_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade11")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade11_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade11")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade11_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade11")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade11():
    ...
    load1 = wade11_nabu(harvest)
    load2 = wade11_nabuprov(load1)
    load3 = wade11_nabuorg(load2)
    load4 = wade11_naburelease(load3)
