...
def cuahsihisccbepdapids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisccbepdapids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisccbepdapids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisccbepdapids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisccbepdapids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisccbepdapids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisccbepdapids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisccbepdapids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisccbepdapids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisccbepdapids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisccbepdapids0():
    ...
    load1 = cuahsihisccbepdapids0_nabu(harvest)
    load2 = cuahsihisccbepdapids0_nabuprov(load1)
    load3 = cuahsihisccbepdapids0_nabuorg(load2)
    load4 = cuahsihisccbepdapids0_naburelease(load3)
