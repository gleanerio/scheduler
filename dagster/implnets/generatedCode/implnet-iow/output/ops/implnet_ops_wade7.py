...
def wade7_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade7")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade7_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade7")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade7_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade7")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade7_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade7")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade7_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade7")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade7():
    ...
    load1 = wade7_nabu(harvest)
    load2 = wade7_nabuprov(load1)
    load3 = wade7_nabuorg(load2)
    load4 = wade7_naburelease(load3)
