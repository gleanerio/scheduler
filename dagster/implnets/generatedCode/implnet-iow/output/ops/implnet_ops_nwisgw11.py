...
def nwisgw11_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw11")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw11_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw11")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw11_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw11")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw11_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw11")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw11_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw11")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw11():
    ...
    load1 = nwisgw11_nabu(harvest)
    load2 = nwisgw11_nabuprov(load1)
    load3 = nwisgw11_nabuorg(load2)
    load4 = nwisgw11_naburelease(load3)
