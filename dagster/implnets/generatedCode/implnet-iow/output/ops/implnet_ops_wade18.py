...
def wade18_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade18")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade18_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade18")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade18_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade18")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade18_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade18")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade18_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade18")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade18():
    ...
    load1 = wade18_nabu(harvest)
    load2 = wade18_nabuprov(load1)
    load3 = wade18_nabuorg(load2)
    load4 = wade18_naburelease(load3)
