...
def places0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "places0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def places0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "places0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def places0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "places0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def places0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "places0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def places0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "places0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_places0():
    ...
    load1 = places0_nabu(harvest)
    load2 = places0_nabuprov(load1)
    load3 = places0_nabuorg(load2)
    load4 = places0_naburelease(load3)
