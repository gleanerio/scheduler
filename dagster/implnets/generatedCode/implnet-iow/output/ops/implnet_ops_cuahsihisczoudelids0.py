...
def cuahsihisczoudelids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisczoudelids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisczoudelids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisczoudelids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczoudelids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisczoudelids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczoudelids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisczoudelids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczoudelids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisczoudelids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisczoudelids0():
    ...
    load1 = cuahsihisczoudelids0_nabu(harvest)
    load2 = cuahsihisczoudelids0_nabuprov(load1)
    load3 = cuahsihisczoudelids0_nabuorg(load2)
    load4 = cuahsihisczoudelids0_naburelease(load3)
