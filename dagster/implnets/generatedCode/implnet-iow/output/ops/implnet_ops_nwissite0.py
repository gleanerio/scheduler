...
def nwissite0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwissite0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwissite0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwissite0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwissite0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwissite0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwissite0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwissite0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwissite0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwissite0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwissite0():
    ...
    load1 = nwissite0_nabu(harvest)
    load2 = nwissite0_nabuprov(load1)
    load3 = nwissite0_nabuorg(load2)
    load4 = nwissite0_naburelease(load3)
