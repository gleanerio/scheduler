...
def gfv11pois1_gleaner(context):
    returned_value = gleanerio(("gleaner"), "gfv11pois1")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def gfv11pois1_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "gfv11pois1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def gfv11pois1_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "gfv11pois1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def gfv11pois1_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "gfv11pois1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def gfv11pois1_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "gfv11pois1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_gfv11pois1():
    ...
    load1 = gfv11pois1_nabu(harvest)
    load2 = gfv11pois1_nabuprov(load1)
    load3 = gfv11pois1_nabuorg(load2)
    load4 = gfv11pois1_naburelease(load3)
