...
def cuahsihisorsancohabids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisorsancohabids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisorsancohabids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisorsancohabids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisorsancohabids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisorsancohabids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisorsancohabids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisorsancohabids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisorsancohabids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisorsancohabids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisorsancohabids0():
    ...
    load1 = cuahsihisorsancohabids0_nabu(harvest)
    load2 = cuahsihisorsancohabids0_nabuprov(load1)
    load3 = cuahsihisorsancohabids0_nabuorg(load2)
    load4 = cuahsihisorsancohabids0_naburelease(load3)
