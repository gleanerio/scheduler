...
@op
def cuahsihisorsancohabids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihisorsancohabids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisorsancohabids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihisorsancohabids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisorsancohabids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihisorsancohabids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisorsancohabids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihisorsancohabids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihisorsancohabids0_uploadrelease(context, msg: str):
...
@op
def cuahsihisorsancohabids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisorsancohabids0")
    ...
    return msg + r
@op
def cuahsihisorsancohabids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisorsancohabids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihisorsancohabids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisorsancohabids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihisorsancohabids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisorsancohabids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisorsancohabids0"
...
def cuahsihisorsancohabids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisorsancohabids0"
...
def harvest_cuahsihisorsancohabids0():
    harvest = cuahsihisorsancohabids0_gleaner()

    report_ms3 = cuahsihisorsancohabids0_missingreport_s3(harvest)
    report_idstat = cuahsihisorsancohabids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihisorsancohabids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihisorsancohabids0")
    load_release = cuahsihisorsancohabids0_naburelease(harvest)
    load_uploadrelease = cuahsihisorsancohabids0_uploadrelease(load_release)

    load_prune = cuahsihisorsancohabids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihisorsancohabids0_nabuprov(load_prune)
    load_org = cuahsihisorsancohabids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihisorsancohabids0_missingreport_graph(load_org)
    report_graph=cuahsihisorsancohabids0_graph_reports(report_msgraph)
