...
def cuahsihismmaatacamaids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihismmaatacamaids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihismmaatacamaids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihismmaatacamaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismmaatacamaids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihismmaatacamaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismmaatacamaids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihismmaatacamaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismmaatacamaids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihismmaatacamaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihismmaatacamaids0():
    ...
    load1 = cuahsihismmaatacamaids0_nabu(harvest)
    load2 = cuahsihismmaatacamaids0_nabuprov(load1)
    load3 = cuahsihismmaatacamaids0_nabuorg(load2)
    load4 = cuahsihismmaatacamaids0_naburelease(load3)
