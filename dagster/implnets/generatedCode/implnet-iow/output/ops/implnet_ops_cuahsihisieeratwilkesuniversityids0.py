...
@op
def cuahsihisieeratwilkesuniversityids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihisieeratwilkesuniversityids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisieeratwilkesuniversityids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihisieeratwilkesuniversityids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisieeratwilkesuniversityids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihisieeratwilkesuniversityids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisieeratwilkesuniversityids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihisieeratwilkesuniversityids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihisieeratwilkesuniversityids0_uploadrelease(context, msg: str):
...
@op
def cuahsihisieeratwilkesuniversityids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisieeratwilkesuniversityids0")
    ...
    return msg + r
@op
def cuahsihisieeratwilkesuniversityids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisieeratwilkesuniversityids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihisieeratwilkesuniversityids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisieeratwilkesuniversityids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihisieeratwilkesuniversityids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisieeratwilkesuniversityids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisieeratwilkesuniversityids0"
...
def cuahsihisieeratwilkesuniversityids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisieeratwilkesuniversityids0"
...
def harvest_cuahsihisieeratwilkesuniversityids0():
    harvest = cuahsihisieeratwilkesuniversityids0_gleaner()

    report_ms3 = cuahsihisieeratwilkesuniversityids0_missingreport_s3(harvest)
    report_idstat = cuahsihisieeratwilkesuniversityids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihisieeratwilkesuniversityids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihisieeratwilkesuniversityids0")
    load_release = cuahsihisieeratwilkesuniversityids0_naburelease(harvest)
    load_uploadrelease = cuahsihisieeratwilkesuniversityids0_uploadrelease(load_release)

    load_prune = cuahsihisieeratwilkesuniversityids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihisieeratwilkesuniversityids0_nabuprov(load_prune)
    load_org = cuahsihisieeratwilkesuniversityids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihisieeratwilkesuniversityids0_missingreport_graph(load_org)
    report_graph=cuahsihisieeratwilkesuniversityids0_graph_reports(report_msgraph)
