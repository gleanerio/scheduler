...
def wade16_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade16")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade16_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade16")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade16_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade16")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade16_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade16")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade16_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade16")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade16():
    ...
    load1 = wade16_nabu(harvest)
    load2 = wade16_nabuprov(load1)
    load3 = wade16_nabuorg(load2)
    load4 = wade16_naburelease(load3)
