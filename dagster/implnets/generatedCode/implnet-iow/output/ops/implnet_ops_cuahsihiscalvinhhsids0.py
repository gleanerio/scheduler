...
def cuahsihiscalvinhhsids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihiscalvinhhsids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihiscalvinhhsids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihiscalvinhhsids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiscalvinhhsids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihiscalvinhhsids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiscalvinhhsids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihiscalvinhhsids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiscalvinhhsids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihiscalvinhhsids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihiscalvinhhsids0():
    ...
    load1 = cuahsihiscalvinhhsids0_nabu(harvest)
    load2 = cuahsihiscalvinhhsids0_nabuprov(load1)
    load3 = cuahsihiscalvinhhsids0_nabuorg(load2)
    load4 = cuahsihiscalvinhhsids0_naburelease(load3)
