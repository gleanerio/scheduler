...
def cuahsihisnceiww2ids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisnceiww2ids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisnceiww2ids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisnceiww2ids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnceiww2ids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisnceiww2ids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnceiww2ids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisnceiww2ids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnceiww2ids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisnceiww2ids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisnceiww2ids0():
    ...
    load1 = cuahsihisnceiww2ids0_nabu(harvest)
    load2 = cuahsihisnceiww2ids0_nabuprov(load1)
    load3 = cuahsihisnceiww2ids0_nabuorg(load2)
    load4 = cuahsihisnceiww2ids0_naburelease(load3)
