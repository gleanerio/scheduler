...
@op
def cuahsihisnceiww2ids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihisnceiww2ids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnceiww2ids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihisnceiww2ids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnceiww2ids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihisnceiww2ids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnceiww2ids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihisnceiww2ids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihisnceiww2ids0_uploadrelease(context, msg: str):
...
@op
def cuahsihisnceiww2ids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisnceiww2ids0")
    ...
    return msg + r
@op
def cuahsihisnceiww2ids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisnceiww2ids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihisnceiww2ids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisnceiww2ids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihisnceiww2ids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisnceiww2ids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisnceiww2ids0"
...
def cuahsihisnceiww2ids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisnceiww2ids0"
...
def harvest_cuahsihisnceiww2ids0():
    harvest = cuahsihisnceiww2ids0_gleaner()

    report_ms3 = cuahsihisnceiww2ids0_missingreport_s3(harvest)
    report_idstat = cuahsihisnceiww2ids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihisnceiww2ids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihisnceiww2ids0")
    load_release = cuahsihisnceiww2ids0_naburelease(harvest)
    load_uploadrelease = cuahsihisnceiww2ids0_uploadrelease(load_release)

    load_prune = cuahsihisnceiww2ids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihisnceiww2ids0_nabuprov(load_prune)
    load_org = cuahsihisnceiww2ids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihisnceiww2ids0_missingreport_graph(load_org)
    report_graph=cuahsihisnceiww2ids0_graph_reports(report_msgraph)
