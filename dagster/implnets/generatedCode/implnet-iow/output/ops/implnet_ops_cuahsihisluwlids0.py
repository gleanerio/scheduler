...
def cuahsihisluwlids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisluwlids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisluwlids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisluwlids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisluwlids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisluwlids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisluwlids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisluwlids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisluwlids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisluwlids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisluwlids0():
    ...
    load1 = cuahsihisluwlids0_nabu(harvest)
    load2 = cuahsihisluwlids0_nabuprov(load1)
    load3 = cuahsihisluwlids0_nabuorg(load2)
    load4 = cuahsihisluwlids0_naburelease(load3)
