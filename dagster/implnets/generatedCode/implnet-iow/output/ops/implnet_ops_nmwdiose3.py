...
def nmwdiose3_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nmwdiose3")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nmwdiose3_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nmwdiose3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose3_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nmwdiose3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose3_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nmwdiose3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose3_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nmwdiose3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nmwdiose3():
    ...
    load1 = nmwdiose3_nabu(harvest)
    load2 = nmwdiose3_nabuprov(load1)
    load3 = nmwdiose3_nabuorg(load2)
    load4 = nmwdiose3_naburelease(load3)
