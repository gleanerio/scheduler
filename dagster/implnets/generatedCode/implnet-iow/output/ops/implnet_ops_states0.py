...
def states0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "states0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def states0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "states0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def states0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "states0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def states0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "states0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def states0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "states0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_states0():
    ...
    load1 = states0_nabu(harvest)
    load2 = states0_nabuprov(load1)
    load3 = states0_nabuorg(load2)
    load4 = states0_naburelease(load3)
