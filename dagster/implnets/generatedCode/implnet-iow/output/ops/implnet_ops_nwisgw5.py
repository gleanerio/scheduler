...
def nwisgw5_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw5")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw5_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw5")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw5_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw5")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw5_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw5")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw5_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw5")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw5():
    ...
    load1 = nwisgw5_nabu(harvest)
    load2 = nwisgw5_nabuprov(load1)
    load3 = nwisgw5_nabuorg(load2)
    load4 = nwisgw5_naburelease(load3)
