...
def cuahsihishydrodataczdids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihishydrodataczdids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihishydrodataczdids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihishydrodataczdids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihishydrodataczdids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihishydrodataczdids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihishydrodataczdids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihishydrodataczdids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihishydrodataczdids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihishydrodataczdids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihishydrodataczdids0():
    ...
    load1 = cuahsihishydrodataczdids0_nabu(harvest)
    load2 = cuahsihishydrodataczdids0_nabuprov(load1)
    load3 = cuahsihishydrodataczdids0_nabuorg(load2)
    load4 = cuahsihishydrodataczdids0_naburelease(load3)
