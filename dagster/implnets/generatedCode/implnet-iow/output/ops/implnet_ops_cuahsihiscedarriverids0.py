...
def cuahsihiscedarriverids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihiscedarriverids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihiscedarriverids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihiscedarriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiscedarriverids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihiscedarriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiscedarriverids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihiscedarriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiscedarriverids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihiscedarriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihiscedarriverids0():
    ...
    load1 = cuahsihiscedarriverids0_nabu(harvest)
    load2 = cuahsihiscedarriverids0_nabuprov(load1)
    load3 = cuahsihiscedarriverids0_nabuorg(load2)
    load4 = cuahsihiscedarriverids0_naburelease(load3)
