...
@op
def cuahsihisczocatalinaids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihisczocatalinaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczocatalinaids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihisczocatalinaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczocatalinaids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihisczocatalinaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczocatalinaids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihisczocatalinaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihisczocatalinaids0_uploadrelease(context, msg: str):
...
@op
def cuahsihisczocatalinaids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisczocatalinaids0")
    ...
    return msg + r
@op
def cuahsihisczocatalinaids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisczocatalinaids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihisczocatalinaids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisczocatalinaids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihisczocatalinaids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisczocatalinaids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisczocatalinaids0"
...
def cuahsihisczocatalinaids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisczocatalinaids0"
...
def harvest_cuahsihisczocatalinaids0():
    harvest = cuahsihisczocatalinaids0_gleaner()

    report_ms3 = cuahsihisczocatalinaids0_missingreport_s3(harvest)
    report_idstat = cuahsihisczocatalinaids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihisczocatalinaids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihisczocatalinaids0")
    load_release = cuahsihisczocatalinaids0_naburelease(harvest)
    load_uploadrelease = cuahsihisczocatalinaids0_uploadrelease(load_release)

    load_prune = cuahsihisczocatalinaids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihisczocatalinaids0_nabuprov(load_prune)
    load_org = cuahsihisczocatalinaids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihisczocatalinaids0_missingreport_graph(load_org)
    report_graph=cuahsihisczocatalinaids0_graph_reports(report_msgraph)
