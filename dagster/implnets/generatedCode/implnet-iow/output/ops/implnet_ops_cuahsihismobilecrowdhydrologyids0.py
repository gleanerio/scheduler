...
def cuahsihismobilecrowdhydrologyids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihismobilecrowdhydrologyids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihismobilecrowdhydrologyids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihismobilecrowdhydrologyids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismobilecrowdhydrologyids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihismobilecrowdhydrologyids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismobilecrowdhydrologyids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihismobilecrowdhydrologyids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismobilecrowdhydrologyids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihismobilecrowdhydrologyids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihismobilecrowdhydrologyids0():
    ...
    load1 = cuahsihismobilecrowdhydrologyids0_nabu(harvest)
    load2 = cuahsihismobilecrowdhydrologyids0_nabuprov(load1)
    load3 = cuahsihismobilecrowdhydrologyids0_nabuorg(load2)
    load4 = cuahsihismobilecrowdhydrologyids0_naburelease(load3)
