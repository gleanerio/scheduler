...
@op
def cuahsihisloganriverids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihisloganriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisloganriverids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihisloganriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisloganriverids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihisloganriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisloganriverids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihisloganriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihisloganriverids0_uploadrelease(context, msg: str):
...
@op
def cuahsihisloganriverids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisloganriverids0")
    ...
    return msg + r
@op
def cuahsihisloganriverids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisloganriverids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihisloganriverids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisloganriverids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihisloganriverids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisloganriverids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisloganriverids0"
...
def cuahsihisloganriverids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisloganriverids0"
...
def harvest_cuahsihisloganriverids0():
    harvest = cuahsihisloganriverids0_gleaner()

    report_ms3 = cuahsihisloganriverids0_missingreport_s3(harvest)
    report_idstat = cuahsihisloganriverids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihisloganriverids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihisloganriverids0")
    load_release = cuahsihisloganriverids0_naburelease(harvest)
    load_uploadrelease = cuahsihisloganriverids0_uploadrelease(load_release)

    load_prune = cuahsihisloganriverids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihisloganriverids0_nabuprov(load_prune)
    load_org = cuahsihisloganriverids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihisloganriverids0_missingreport_graph(load_org)
    report_graph=cuahsihisloganriverids0_graph_reports(report_msgraph)
