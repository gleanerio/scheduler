...
def nataq0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nataq0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nataq0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nataq0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nataq0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nataq0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nataq0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nataq0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nataq0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nataq0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nataq0():
    ...
    load1 = nataq0_nabu(harvest)
    load2 = nataq0_nabuprov(load1)
    load3 = nataq0_nabuorg(load2)
    load4 = nataq0_naburelease(load3)
