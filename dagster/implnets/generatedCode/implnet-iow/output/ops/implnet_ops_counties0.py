...
def counties0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "counties0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def counties0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "counties0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def counties0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "counties0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def counties0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "counties0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def counties0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "counties0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_counties0():
    ...
    load1 = counties0_nabu(harvest)
    load2 = counties0_nabuprov(load1)
    load3 = counties0_nabuorg(load2)
    load4 = counties0_naburelease(load3)
