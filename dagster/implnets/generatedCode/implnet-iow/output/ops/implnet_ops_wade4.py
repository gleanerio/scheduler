...
def wade4_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade4")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade4_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade4")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade4_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade4")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade4_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade4")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade4_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade4")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade4():
    ...
    load1 = wade4_nabu(harvest)
    load2 = wade4_nabuprov(load1)
    load3 = wade4_nabuorg(load2)
    load4 = wade4_naburelease(load3)
