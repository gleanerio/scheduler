...
def refgage2_gleaner(context):
    returned_value = gleanerio(("gleaner"), "refgage2")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def refgage2_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "refgage2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def refgage2_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "refgage2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def refgage2_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "refgage2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def refgage2_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "refgage2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_refgage2():
    ...
    load1 = refgage2_nabu(harvest)
    load2 = refgage2_nabuprov(load1)
    load3 = refgage2_nabuorg(load2)
    load4 = refgage2_naburelease(load3)
