...
def cuahsihiskansasweatherdataids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihiskansasweatherdataids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihiskansasweatherdataids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihiskansasweatherdataids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiskansasweatherdataids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihiskansasweatherdataids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiskansasweatherdataids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihiskansasweatherdataids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiskansasweatherdataids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihiskansasweatherdataids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihiskansasweatherdataids0():
    ...
    load1 = cuahsihiskansasweatherdataids0_nabu(harvest)
    load2 = cuahsihiskansasweatherdataids0_nabuprov(load1)
    load3 = cuahsihiskansasweatherdataids0_nabuorg(load2)
    load4 = cuahsihiskansasweatherdataids0_naburelease(load3)
