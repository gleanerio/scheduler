...
def nmwdiose2_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nmwdiose2")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nmwdiose2_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nmwdiose2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose2_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nmwdiose2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose2_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nmwdiose2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose2_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nmwdiose2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nmwdiose2():
    ...
    load1 = nmwdiose2_nabu(harvest)
    load2 = nmwdiose2_nabuprov(load1)
    load3 = nmwdiose2_nabuorg(load2)
    load4 = nmwdiose2_naburelease(load3)
