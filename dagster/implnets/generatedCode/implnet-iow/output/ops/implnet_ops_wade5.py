...
def wade5_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade5")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade5_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade5")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade5_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade5")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade5_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade5")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade5_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade5")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade5():
    ...
    load1 = wade5_nabu(harvest)
    load2 = wade5_nabuprov(load1)
    load3 = wade5_nabuorg(load2)
    load4 = wade5_naburelease(load3)
