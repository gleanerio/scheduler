...
def cuahsihisgonggaids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisgonggaids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisgonggaids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisgonggaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgonggaids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisgonggaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgonggaids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisgonggaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgonggaids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisgonggaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisgonggaids0():
    ...
    load1 = cuahsihisgonggaids0_nabu(harvest)
    load2 = cuahsihisgonggaids0_nabuprov(load1)
    load3 = cuahsihisgonggaids0_nabuorg(load2)
    load4 = cuahsihisgonggaids0_naburelease(load3)
