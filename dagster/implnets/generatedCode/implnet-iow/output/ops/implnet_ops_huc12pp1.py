...
def huc12pp1_gleaner(context):
    returned_value = gleanerio(("gleaner"), "huc12pp1")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def huc12pp1_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "huc12pp1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def huc12pp1_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "huc12pp1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def huc12pp1_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "huc12pp1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def huc12pp1_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "huc12pp1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_huc12pp1():
    ...
    load1 = huc12pp1_nabu(harvest)
    load2 = huc12pp1_nabuprov(load1)
    load3 = huc12pp1_nabuorg(load2)
    load4 = huc12pp1_naburelease(load3)
