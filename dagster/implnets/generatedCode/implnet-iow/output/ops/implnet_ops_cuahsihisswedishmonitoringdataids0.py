...
def cuahsihisswedishmonitoringdataids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisswedishmonitoringdataids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisswedishmonitoringdataids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisswedishmonitoringdataids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisswedishmonitoringdataids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisswedishmonitoringdataids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisswedishmonitoringdataids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisswedishmonitoringdataids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisswedishmonitoringdataids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisswedishmonitoringdataids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisswedishmonitoringdataids0():
    ...
    load1 = cuahsihisswedishmonitoringdataids0_nabu(harvest)
    load2 = cuahsihisswedishmonitoringdataids0_nabuprov(load1)
    load3 = cuahsihisswedishmonitoringdataids0_nabuorg(load2)
    load4 = cuahsihisswedishmonitoringdataids0_naburelease(load3)
