...
def dams0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "dams0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def dams0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "dams0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def dams0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "dams0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def dams0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "dams0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def dams0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "dams0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_dams0():
    ...
    load1 = dams0_nabu(harvest)
    load2 = dams0_nabuprov(load1)
    load3 = dams0_nabuorg(load2)
    load4 = dams0_naburelease(load3)
