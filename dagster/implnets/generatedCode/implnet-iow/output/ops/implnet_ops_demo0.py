...
def demo0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "demo0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def demo0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "demo0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def demo0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "demo0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def demo0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "demo0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def demo0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "demo0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_demo0():
    ...
    load1 = demo0_nabu(harvest)
    load2 = demo0_nabuprov(load1)
    load3 = demo0_nabuorg(load2)
    load4 = demo0_naburelease(load3)
