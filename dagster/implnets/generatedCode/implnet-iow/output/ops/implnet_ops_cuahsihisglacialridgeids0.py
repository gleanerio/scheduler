...
@op
def cuahsihisglacialridgeids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihisglacialridgeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisglacialridgeids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihisglacialridgeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisglacialridgeids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihisglacialridgeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisglacialridgeids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihisglacialridgeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihisglacialridgeids0_uploadrelease(context, msg: str):
...
@op
def cuahsihisglacialridgeids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisglacialridgeids0")
    ...
    return msg + r
@op
def cuahsihisglacialridgeids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisglacialridgeids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihisglacialridgeids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisglacialridgeids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihisglacialridgeids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisglacialridgeids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisglacialridgeids0"
...
def cuahsihisglacialridgeids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisglacialridgeids0"
...
def harvest_cuahsihisglacialridgeids0():
    harvest = cuahsihisglacialridgeids0_gleaner()

    report_ms3 = cuahsihisglacialridgeids0_missingreport_s3(harvest)
    report_idstat = cuahsihisglacialridgeids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihisglacialridgeids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihisglacialridgeids0")
    load_release = cuahsihisglacialridgeids0_naburelease(harvest)
    load_uploadrelease = cuahsihisglacialridgeids0_uploadrelease(load_release)

    load_prune = cuahsihisglacialridgeids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihisglacialridgeids0_nabuprov(load_prune)
    load_org = cuahsihisglacialridgeids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihisglacialridgeids0_missingreport_graph(load_org)
    report_graph=cuahsihisglacialridgeids0_graph_reports(report_msgraph)
