...
def wade3_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade3")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade3_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade3_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade3_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade3_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade3():
    ...
    load1 = wade3_nabu(harvest)
    load2 = wade3_nabuprov(load1)
    load3 = wade3_nabuorg(load2)
    load4 = wade3_naburelease(load3)
