...
def cuahsihismopexids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihismopexids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihismopexids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihismopexids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismopexids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihismopexids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismopexids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihismopexids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismopexids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihismopexids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihismopexids0():
    ...
    load1 = cuahsihismopexids0_nabu(harvest)
    load2 = cuahsihismopexids0_nabuprov(load1)
    load3 = cuahsihismopexids0_nabuorg(load2)
    load4 = cuahsihismopexids0_naburelease(load3)
