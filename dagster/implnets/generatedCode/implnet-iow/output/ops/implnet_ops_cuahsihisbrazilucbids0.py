...
def cuahsihisbrazilucbids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisbrazilucbids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisbrazilucbids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisbrazilucbids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisbrazilucbids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisbrazilucbids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisbrazilucbids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisbrazilucbids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisbrazilucbids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisbrazilucbids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisbrazilucbids0():
    ...
    load1 = cuahsihisbrazilucbids0_nabu(harvest)
    load2 = cuahsihisbrazilucbids0_nabuprov(load1)
    load3 = cuahsihisbrazilucbids0_nabuorg(load2)
    load4 = cuahsihisbrazilucbids0_naburelease(load3)
