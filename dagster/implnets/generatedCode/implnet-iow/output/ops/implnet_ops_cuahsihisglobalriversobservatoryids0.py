...
@op
def cuahsihisglobalriversobservatoryids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihisglobalriversobservatoryids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisglobalriversobservatoryids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihisglobalriversobservatoryids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisglobalriversobservatoryids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihisglobalriversobservatoryids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisglobalriversobservatoryids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihisglobalriversobservatoryids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihisglobalriversobservatoryids0_uploadrelease(context, msg: str):
...
@op
def cuahsihisglobalriversobservatoryids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisglobalriversobservatoryids0")
    ...
    return msg + r
@op
def cuahsihisglobalriversobservatoryids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisglobalriversobservatoryids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihisglobalriversobservatoryids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisglobalriversobservatoryids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihisglobalriversobservatoryids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisglobalriversobservatoryids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisglobalriversobservatoryids0"
...
def cuahsihisglobalriversobservatoryids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisglobalriversobservatoryids0"
...
def harvest_cuahsihisglobalriversobservatoryids0():
    harvest = cuahsihisglobalriversobservatoryids0_gleaner()

    report_ms3 = cuahsihisglobalriversobservatoryids0_missingreport_s3(harvest)
    report_idstat = cuahsihisglobalriversobservatoryids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihisglobalriversobservatoryids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihisglobalriversobservatoryids0")
    load_release = cuahsihisglobalriversobservatoryids0_naburelease(harvest)
    load_uploadrelease = cuahsihisglobalriversobservatoryids0_uploadrelease(load_release)

    load_prune = cuahsihisglobalriversobservatoryids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihisglobalriversobservatoryids0_nabuprov(load_prune)
    load_org = cuahsihisglobalriversobservatoryids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihisglobalriversobservatoryids0_missingreport_graph(load_org)
    report_graph=cuahsihisglobalriversobservatoryids0_graph_reports(report_msgraph)
