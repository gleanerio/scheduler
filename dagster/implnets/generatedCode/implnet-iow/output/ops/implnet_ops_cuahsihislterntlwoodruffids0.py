...
@op
def cuahsihislterntlwoodruffids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihislterntlwoodruffids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislterntlwoodruffids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihislterntlwoodruffids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislterntlwoodruffids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihislterntlwoodruffids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislterntlwoodruffids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihislterntlwoodruffids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihislterntlwoodruffids0_uploadrelease(context, msg: str):
...
@op
def cuahsihislterntlwoodruffids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihislterntlwoodruffids0")
    ...
    return msg + r
@op
def cuahsihislterntlwoodruffids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihislterntlwoodruffids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihislterntlwoodruffids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihislterntlwoodruffids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihislterntlwoodruffids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihislterntlwoodruffids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihislterntlwoodruffids0"
...
def cuahsihislterntlwoodruffids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihislterntlwoodruffids0"
...
def harvest_cuahsihislterntlwoodruffids0():
    harvest = cuahsihislterntlwoodruffids0_gleaner()

    report_ms3 = cuahsihislterntlwoodruffids0_missingreport_s3(harvest)
    report_idstat = cuahsihislterntlwoodruffids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihislterntlwoodruffids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihislterntlwoodruffids0")
    load_release = cuahsihislterntlwoodruffids0_naburelease(harvest)
    load_uploadrelease = cuahsihislterntlwoodruffids0_uploadrelease(load_release)

    load_prune = cuahsihislterntlwoodruffids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihislterntlwoodruffids0_nabuprov(load_prune)
    load_org = cuahsihislterntlwoodruffids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihislterntlwoodruffids0_missingreport_graph(load_org)
    report_graph=cuahsihislterntlwoodruffids0_graph_reports(report_msgraph)
