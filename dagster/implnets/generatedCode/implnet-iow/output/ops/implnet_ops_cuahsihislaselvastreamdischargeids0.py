...
def cuahsihislaselvastreamdischargeids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihislaselvastreamdischargeids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihislaselvastreamdischargeids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihislaselvastreamdischargeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislaselvastreamdischargeids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihislaselvastreamdischargeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislaselvastreamdischargeids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihislaselvastreamdischargeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislaselvastreamdischargeids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihislaselvastreamdischargeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihislaselvastreamdischargeids0():
    ...
    load1 = cuahsihislaselvastreamdischargeids0_nabu(harvest)
    load2 = cuahsihislaselvastreamdischargeids0_nabuprov(load1)
    load3 = cuahsihislaselvastreamdischargeids0_nabuorg(load2)
    load4 = cuahsihislaselvastreamdischargeids0_naburelease(load3)
