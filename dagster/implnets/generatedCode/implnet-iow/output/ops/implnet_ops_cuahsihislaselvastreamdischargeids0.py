...
@op
def cuahsihislaselvastreamdischargeids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihislaselvastreamdischargeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislaselvastreamdischargeids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihislaselvastreamdischargeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislaselvastreamdischargeids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihislaselvastreamdischargeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislaselvastreamdischargeids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihislaselvastreamdischargeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihislaselvastreamdischargeids0_uploadrelease(context, msg: str):
...
@op
def cuahsihislaselvastreamdischargeids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihislaselvastreamdischargeids0")
    ...
    return msg + r
@op
def cuahsihislaselvastreamdischargeids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihislaselvastreamdischargeids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihislaselvastreamdischargeids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihislaselvastreamdischargeids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihislaselvastreamdischargeids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihislaselvastreamdischargeids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihislaselvastreamdischargeids0"
...
def cuahsihislaselvastreamdischargeids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihislaselvastreamdischargeids0"
...
def harvest_cuahsihislaselvastreamdischargeids0():
    harvest = cuahsihislaselvastreamdischargeids0_gleaner()

    report_ms3 = cuahsihislaselvastreamdischargeids0_missingreport_s3(harvest)
    report_idstat = cuahsihislaselvastreamdischargeids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihislaselvastreamdischargeids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihislaselvastreamdischargeids0")
    load_release = cuahsihislaselvastreamdischargeids0_naburelease(harvest)
    load_uploadrelease = cuahsihislaselvastreamdischargeids0_uploadrelease(load_release)

    load_prune = cuahsihislaselvastreamdischargeids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihislaselvastreamdischargeids0_nabuprov(load_prune)
    load_org = cuahsihislaselvastreamdischargeids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihislaselvastreamdischargeids0_missingreport_graph(load_org)
    report_graph=cuahsihislaselvastreamdischargeids0_graph_reports(report_msgraph)
