...
def cuahsihisnewnids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisnewnids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisnewnids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisnewnids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnewnids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisnewnids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnewnids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisnewnids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnewnids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisnewnids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisnewnids0():
    ...
    load1 = cuahsihisnewnids0_nabu(harvest)
    load2 = cuahsihisnewnids0_nabuprov(load1)
    load3 = cuahsihisnewnids0_nabuorg(load2)
    load4 = cuahsihisnewnids0_naburelease(load3)
