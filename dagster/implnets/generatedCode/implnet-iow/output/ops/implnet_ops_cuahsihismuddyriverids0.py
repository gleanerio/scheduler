...
def cuahsihismuddyriverids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihismuddyriverids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihismuddyriverids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihismuddyriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismuddyriverids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihismuddyriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismuddyriverids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihismuddyriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismuddyriverids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihismuddyriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihismuddyriverids0():
    ...
    load1 = cuahsihismuddyriverids0_nabu(harvest)
    load2 = cuahsihismuddyriverids0_nabuprov(load1)
    load3 = cuahsihismuddyriverids0_nabuorg(load2)
    load4 = cuahsihismuddyriverids0_naburelease(load3)
