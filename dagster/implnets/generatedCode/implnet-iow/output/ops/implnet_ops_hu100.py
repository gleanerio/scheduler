...
def hu100_gleaner(context):
    returned_value = gleanerio(("gleaner"), "hu100")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def hu100_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "hu100")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu100_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "hu100")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu100_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "hu100")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu100_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "hu100")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_hu100():
    ...
    load1 = hu100_nabu(harvest)
    load2 = hu100_nabuprov(load1)
    load3 = hu100_nabuorg(load2)
    load4 = hu100_naburelease(load3)
