...
@op
def cuahsihisweiherbachids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihisweiherbachids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def cuahsihisweiherbachids0_naburelease(context, msg: str):
    ...
    return msg + r
@op
def cuahsihisweiherbachids0_uploadrelease(context, msg: str):
...
@op
def cuahsihisweiherbachids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisweiherbachids0")
    ...
    return msg + r
@op
def cuahsihisweiherbachids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisweiherbachids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihisweiherbachids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisweiherbachids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihisweiherbachids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisweiherbachids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisweiherbachids0"
...
def cuahsihisweiherbachids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisweiherbachids0"
...
def harvest_cuahsihisweiherbachids0():
    ...
    report_ms3 = cuahsihisweiherbachids0_missingreport_s3(harvest)
    report_idstat = cuahsihisweiherbachids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihisweiherbachids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihisweiherbachids0")
    load_release = cuahsihisweiherbachids0_naburelease(harvest)
    load_uploadrelease = cuahsihisweiherbachids0_uploadrelease(load_release)

    load_prune = cuahsihisweiherbachids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihisweiherbachids0_nabuprov(load_prune)
    load_org = cuahsihisweiherbachids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihisweiherbachids0_missingreport_graph(load_org)
    report_graph=cuahsihisweiherbachids0_graph_reports(report_msgraph)
