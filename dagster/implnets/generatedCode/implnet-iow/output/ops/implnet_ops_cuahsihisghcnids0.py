...
def cuahsihisghcnids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisghcnids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisghcnids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisghcnids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisghcnids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisghcnids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisghcnids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisghcnids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisghcnids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisghcnids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisghcnids0():
    ...
    load1 = cuahsihisghcnids0_nabu(harvest)
    load2 = cuahsihisghcnids0_nabuprov(load1)
    load3 = cuahsihisghcnids0_nabuorg(load2)
    load4 = cuahsihisghcnids0_naburelease(load3)
