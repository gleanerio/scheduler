...
def cuahsihisumbcwqids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisumbcwqids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisumbcwqids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisumbcwqids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisumbcwqids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisumbcwqids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisumbcwqids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisumbcwqids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisumbcwqids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisumbcwqids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisumbcwqids0():
    ...
    load1 = cuahsihisumbcwqids0_nabu(harvest)
    load2 = cuahsihisumbcwqids0_nabuprov(load1)
    load3 = cuahsihisumbcwqids0_nabuorg(load2)
    load4 = cuahsihisumbcwqids0_naburelease(load3)
