...
@op
def cuahsihisumbcwqids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihisumbcwqids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisumbcwqids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihisumbcwqids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisumbcwqids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihisumbcwqids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisumbcwqids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihisumbcwqids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihisumbcwqids0_uploadrelease(context, msg: str):
...
@op
def cuahsihisumbcwqids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisumbcwqids0")
    ...
    return msg + r
@op
def cuahsihisumbcwqids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisumbcwqids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihisumbcwqids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisumbcwqids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihisumbcwqids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisumbcwqids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisumbcwqids0"
...
def cuahsihisumbcwqids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisumbcwqids0"
...
def harvest_cuahsihisumbcwqids0():
    harvest = cuahsihisumbcwqids0_gleaner()

    report_ms3 = cuahsihisumbcwqids0_missingreport_s3(harvest)
    report_idstat = cuahsihisumbcwqids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihisumbcwqids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihisumbcwqids0")
    load_release = cuahsihisumbcwqids0_naburelease(harvest)
    load_uploadrelease = cuahsihisumbcwqids0_uploadrelease(load_release)

    load_prune = cuahsihisumbcwqids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihisumbcwqids0_nabuprov(load_prune)
    load_org = cuahsihisumbcwqids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihisumbcwqids0_missingreport_graph(load_org)
    report_graph=cuahsihisumbcwqids0_graph_reports(report_msgraph)
