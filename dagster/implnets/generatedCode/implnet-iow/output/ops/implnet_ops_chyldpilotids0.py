...
def chyldpilotids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "chyldpilotids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def chyldpilotids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "chyldpilotids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def chyldpilotids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "chyldpilotids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def chyldpilotids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "chyldpilotids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def chyldpilotids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "chyldpilotids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_chyldpilotids0():
    ...
    load1 = chyldpilotids0_nabu(harvest)
    load2 = chyldpilotids0_nabuprov(load1)
    load3 = chyldpilotids0_nabuorg(load2)
    load4 = chyldpilotids0_naburelease(load3)
