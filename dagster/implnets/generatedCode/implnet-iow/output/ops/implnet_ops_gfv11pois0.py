...
def gfv11pois0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "gfv11pois0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def gfv11pois0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "gfv11pois0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def gfv11pois0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "gfv11pois0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def gfv11pois0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "gfv11pois0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def gfv11pois0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "gfv11pois0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_gfv11pois0():
    ...
    load1 = gfv11pois0_nabu(harvest)
    load2 = gfv11pois0_nabuprov(load1)
    load3 = gfv11pois0_nabuorg(load2)
    load4 = gfv11pois0_naburelease(load3)
