...
def cuahsihislittlebearriverids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihislittlebearriverids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihislittlebearriverids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihislittlebearriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislittlebearriverids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihislittlebearriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislittlebearriverids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihislittlebearriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislittlebearriverids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihislittlebearriverids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihislittlebearriverids0():
    ...
    load1 = cuahsihislittlebearriverids0_nabu(harvest)
    load2 = cuahsihislittlebearriverids0_nabuprov(load1)
    load3 = cuahsihislittlebearriverids0_nabuorg(load2)
    load4 = cuahsihislittlebearriverids0_naburelease(load3)
