...
def hmw0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "hmw0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def hmw0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "hmw0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hmw0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "hmw0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hmw0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "hmw0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hmw0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "hmw0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_hmw0():
    ...
    load1 = hmw0_nabu(harvest)
    load2 = hmw0_nabuprov(load1)
    load3 = hmw0_nabuorg(load2)
    load4 = hmw0_naburelease(load3)
