...
def nmwdiose1_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nmwdiose1")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nmwdiose1_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nmwdiose1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose1_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nmwdiose1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose1_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nmwdiose1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose1_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nmwdiose1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nmwdiose1():
    ...
    load1 = nmwdiose1_nabu(harvest)
    load2 = nmwdiose1_nabuprov(load1)
    load3 = nmwdiose1_nabuorg(load2)
    load4 = nmwdiose1_naburelease(load3)
