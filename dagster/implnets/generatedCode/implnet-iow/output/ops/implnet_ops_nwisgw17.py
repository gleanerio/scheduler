...
def nwisgw17_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw17")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw17_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw17")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw17_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw17")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw17_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw17")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw17_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw17")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw17():
    ...
    load1 = nwisgw17_nabu(harvest)
    load2 = nwisgw17_nabuprov(load1)
    load3 = nwisgw17_nabuorg(load2)
    load4 = nwisgw17_naburelease(load3)
