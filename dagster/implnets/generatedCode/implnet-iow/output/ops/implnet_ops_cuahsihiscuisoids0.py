...
def cuahsihiscuisoids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihiscuisoids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihiscuisoids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihiscuisoids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiscuisoids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihiscuisoids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiscuisoids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihiscuisoids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiscuisoids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihiscuisoids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihiscuisoids0():
    ...
    load1 = cuahsihiscuisoids0_nabu(harvest)
    load2 = cuahsihiscuisoids0_nabuprov(load1)
    load3 = cuahsihiscuisoids0_nabuorg(load2)
    load4 = cuahsihiscuisoids0_naburelease(load3)
