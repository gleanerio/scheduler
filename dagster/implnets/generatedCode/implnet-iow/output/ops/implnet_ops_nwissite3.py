...
def nwissite3_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwissite3")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwissite3_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwissite3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwissite3_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwissite3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwissite3_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwissite3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwissite3_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwissite3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwissite3():
    ...
    load1 = nwissite3_nabu(harvest)
    load2 = nwissite3_nabuprov(load1)
    load3 = nwissite3_nabuorg(load2)
    load4 = nwissite3_naburelease(load3)
