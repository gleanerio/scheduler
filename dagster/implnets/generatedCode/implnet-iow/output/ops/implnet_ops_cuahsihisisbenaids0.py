...
def cuahsihisisbenaids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisisbenaids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisisbenaids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisisbenaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisisbenaids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisisbenaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisisbenaids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisisbenaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisisbenaids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisisbenaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisisbenaids0():
    ...
    load1 = cuahsihisisbenaids0_nabu(harvest)
    load2 = cuahsihisisbenaids0_nabuprov(load1)
    load3 = cuahsihisisbenaids0_nabuorg(load2)
    load4 = cuahsihisisbenaids0_naburelease(load3)
