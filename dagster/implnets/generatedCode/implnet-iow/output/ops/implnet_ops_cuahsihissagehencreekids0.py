...
def cuahsihissagehencreekids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihissagehencreekids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihissagehencreekids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihissagehencreekids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihissagehencreekids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihissagehencreekids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihissagehencreekids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihissagehencreekids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihissagehencreekids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihissagehencreekids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihissagehencreekids0():
    ...
    load1 = cuahsihissagehencreekids0_nabu(harvest)
    load2 = cuahsihissagehencreekids0_nabuprov(load1)
    load3 = cuahsihissagehencreekids0_nabuorg(load2)
    load4 = cuahsihissagehencreekids0_naburelease(load3)
