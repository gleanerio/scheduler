...
def nwisgw16_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw16")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw16_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw16")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw16_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw16")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw16_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw16")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw16_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw16")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw16():
    ...
    load1 = nwisgw16_nabu(harvest)
    load2 = nwisgw16_nabuprov(load1)
    load3 = nwisgw16_nabuorg(load2)
    load4 = nwisgw16_naburelease(load3)
