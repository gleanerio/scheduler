...
def nwisgw24_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw24")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw24_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw24")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw24_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw24")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw24_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw24")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw24_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw24")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw24():
    ...
    load1 = nwisgw24_nabu(harvest)
    load2 = nwisgw24_nabuprov(load1)
    load3 = nwisgw24_nabuorg(load2)
    load4 = nwisgw24_naburelease(load3)
