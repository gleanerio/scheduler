...
def cuahsihismudlakeids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihismudlakeids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihismudlakeids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihismudlakeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismudlakeids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihismudlakeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismudlakeids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihismudlakeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismudlakeids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihismudlakeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihismudlakeids0():
    ...
    load1 = cuahsihismudlakeids0_nabu(harvest)
    load2 = cuahsihismudlakeids0_nabuprov(load1)
    load3 = cuahsihismudlakeids0_nabuorg(load2)
    load4 = cuahsihismudlakeids0_naburelease(load3)
