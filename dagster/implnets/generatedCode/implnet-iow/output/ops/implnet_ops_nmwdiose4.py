...
def nmwdiose4_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nmwdiose4")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nmwdiose4_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nmwdiose4")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose4_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nmwdiose4")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose4_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nmwdiose4")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose4_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nmwdiose4")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nmwdiose4():
    ...
    load1 = nmwdiose4_nabu(harvest)
    load2 = nmwdiose4_nabuprov(load1)
    load3 = nmwdiose4_nabuorg(load2)
    load4 = nmwdiose4_naburelease(load3)
