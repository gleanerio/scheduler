...
def cuahsihisloganrivergamutids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisloganrivergamutids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisloganrivergamutids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisloganrivergamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisloganrivergamutids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisloganrivergamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisloganrivergamutids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisloganrivergamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisloganrivergamutids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisloganrivergamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisloganrivergamutids0():
    ...
    load1 = cuahsihisloganrivergamutids0_nabu(harvest)
    load2 = cuahsihisloganrivergamutids0_nabuprov(load1)
    load3 = cuahsihisloganrivergamutids0_nabuorg(load2)
    load4 = cuahsihisloganrivergamutids0_naburelease(load3)
