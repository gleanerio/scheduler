...
@op
def cuahsihisloganrivergamutids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihisloganrivergamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisloganrivergamutids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihisloganrivergamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisloganrivergamutids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihisloganrivergamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisloganrivergamutids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihisloganrivergamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihisloganrivergamutids0_uploadrelease(context, msg: str):
...
@op
def cuahsihisloganrivergamutids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisloganrivergamutids0")
    ...
    return msg + r
@op
def cuahsihisloganrivergamutids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisloganrivergamutids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihisloganrivergamutids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisloganrivergamutids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihisloganrivergamutids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisloganrivergamutids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisloganrivergamutids0"
...
def cuahsihisloganrivergamutids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisloganrivergamutids0"
...
def harvest_cuahsihisloganrivergamutids0():
    harvest = cuahsihisloganrivergamutids0_gleaner()

    report_ms3 = cuahsihisloganrivergamutids0_missingreport_s3(harvest)
    report_idstat = cuahsihisloganrivergamutids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihisloganrivergamutids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihisloganrivergamutids0")
    load_release = cuahsihisloganrivergamutids0_naburelease(harvest)
    load_uploadrelease = cuahsihisloganrivergamutids0_uploadrelease(load_release)

    load_prune = cuahsihisloganrivergamutids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihisloganrivergamutids0_nabuprov(load_prune)
    load_org = cuahsihisloganrivergamutids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihisloganrivergamutids0_missingreport_graph(load_org)
    report_graph=cuahsihisloganrivergamutids0_graph_reports(report_msgraph)
