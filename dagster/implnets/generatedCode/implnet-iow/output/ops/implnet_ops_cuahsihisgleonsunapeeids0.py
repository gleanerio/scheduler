...
@op
def cuahsihisgleonsunapeeids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihisgleonsunapeeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonsunapeeids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihisgleonsunapeeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonsunapeeids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihisgleonsunapeeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonsunapeeids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihisgleonsunapeeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihisgleonsunapeeids0_uploadrelease(context, msg: str):
...
@op
def cuahsihisgleonsunapeeids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisgleonsunapeeids0")
    ...
    return msg + r
@op
def cuahsihisgleonsunapeeids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisgleonsunapeeids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihisgleonsunapeeids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisgleonsunapeeids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihisgleonsunapeeids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisgleonsunapeeids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisgleonsunapeeids0"
...
def cuahsihisgleonsunapeeids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisgleonsunapeeids0"
...
def harvest_cuahsihisgleonsunapeeids0():
    harvest = cuahsihisgleonsunapeeids0_gleaner()

    report_ms3 = cuahsihisgleonsunapeeids0_missingreport_s3(harvest)
    report_idstat = cuahsihisgleonsunapeeids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihisgleonsunapeeids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihisgleonsunapeeids0")
    load_release = cuahsihisgleonsunapeeids0_naburelease(harvest)
    load_uploadrelease = cuahsihisgleonsunapeeids0_uploadrelease(load_release)

    load_prune = cuahsihisgleonsunapeeids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihisgleonsunapeeids0_nabuprov(load_prune)
    load_org = cuahsihisgleonsunapeeids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihisgleonsunapeeids0_missingreport_graph(load_org)
    report_graph=cuahsihisgleonsunapeeids0_graph_reports(report_msgraph)
