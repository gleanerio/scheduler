...
def cuahsihisgleonsunapeeids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisgleonsunapeeids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisgleonsunapeeids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisgleonsunapeeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonsunapeeids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisgleonsunapeeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonsunapeeids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisgleonsunapeeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonsunapeeids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisgleonsunapeeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisgleonsunapeeids0():
    ...
    load1 = cuahsihisgleonsunapeeids0_nabu(harvest)
    load2 = cuahsihisgleonsunapeeids0_nabuprov(load1)
    load3 = cuahsihisgleonsunapeeids0_nabuorg(load2)
    load4 = cuahsihisgleonsunapeeids0_naburelease(load3)
