...
def cuahsihisyosemitehydroclimatenetworkids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisyosemitehydroclimatenetworkids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisyosemitehydroclimatenetworkids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisyosemitehydroclimatenetworkids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisyosemitehydroclimatenetworkids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisyosemitehydroclimatenetworkids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisyosemitehydroclimatenetworkids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisyosemitehydroclimatenetworkids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisyosemitehydroclimatenetworkids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisyosemitehydroclimatenetworkids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisyosemitehydroclimatenetworkids0():
    ...
    load1 = cuahsihisyosemitehydroclimatenetworkids0_nabu(harvest)
    load2 = cuahsihisyosemitehydroclimatenetworkids0_nabuprov(load1)
    load3 = cuahsihisyosemitehydroclimatenetworkids0_nabuorg(load2)
    load4 = cuahsihisyosemitehydroclimatenetworkids0_naburelease(load3)
