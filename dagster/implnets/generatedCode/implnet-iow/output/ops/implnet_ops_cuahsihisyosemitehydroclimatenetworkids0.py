...
@op
def cuahsihisyosemitehydroclimatenetworkids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihisyosemitehydroclimatenetworkids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisyosemitehydroclimatenetworkids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihisyosemitehydroclimatenetworkids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisyosemitehydroclimatenetworkids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihisyosemitehydroclimatenetworkids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisyosemitehydroclimatenetworkids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihisyosemitehydroclimatenetworkids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihisyosemitehydroclimatenetworkids0_uploadrelease(context, msg: str):
...
@op
def cuahsihisyosemitehydroclimatenetworkids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisyosemitehydroclimatenetworkids0")
    ...
    return msg + r
@op
def cuahsihisyosemitehydroclimatenetworkids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisyosemitehydroclimatenetworkids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihisyosemitehydroclimatenetworkids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisyosemitehydroclimatenetworkids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihisyosemitehydroclimatenetworkids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisyosemitehydroclimatenetworkids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisyosemitehydroclimatenetworkids0"
...
def cuahsihisyosemitehydroclimatenetworkids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisyosemitehydroclimatenetworkids0"
...
def harvest_cuahsihisyosemitehydroclimatenetworkids0():
    ...
    report_ms3 = cuahsihisyosemitehydroclimatenetworkids0_missingreport_s3(harvest)
    report_idstat = cuahsihisyosemitehydroclimatenetworkids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihisyosemitehydroclimatenetworkids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihisyosemitehydroclimatenetworkids0")
    load_release = cuahsihisyosemitehydroclimatenetworkids0_naburelease(harvest)
    load_uploadrelease = cuahsihisyosemitehydroclimatenetworkids0_uploadrelease(load_release)

    load_prune = cuahsihisyosemitehydroclimatenetworkids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihisyosemitehydroclimatenetworkids0_nabuprov(load_prune)
    load_org = cuahsihisyosemitehydroclimatenetworkids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihisyosemitehydroclimatenetworkids0_missingreport_graph(load_org)
    report_graph=cuahsihisyosemitehydroclimatenetworkids0_graph_reports(report_msgraph)
