...
def cuahsihismwraids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihismwraids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihismwraids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihismwraids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismwraids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihismwraids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismwraids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihismwraids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismwraids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihismwraids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihismwraids0():
    ...
    load1 = cuahsihismwraids0_nabu(harvest)
    load2 = cuahsihismwraids0_nabuprov(load1)
    load3 = cuahsihismwraids0_nabuorg(load2)
    load4 = cuahsihismwraids0_naburelease(load3)
