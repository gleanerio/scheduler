...
def cuahsihisgleondorsetids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisgleondorsetids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisgleondorsetids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisgleondorsetids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleondorsetids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisgleondorsetids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleondorsetids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisgleondorsetids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleondorsetids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisgleondorsetids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisgleondorsetids0():
    ...
    load1 = cuahsihisgleondorsetids0_nabu(harvest)
    load2 = cuahsihisgleondorsetids0_nabuprov(load1)
    load3 = cuahsihisgleondorsetids0_nabuorg(load2)
    load4 = cuahsihisgleondorsetids0_naburelease(load3)
