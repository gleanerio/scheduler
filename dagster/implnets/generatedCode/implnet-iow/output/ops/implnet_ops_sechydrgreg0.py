...
def sechydrgreg0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "sechydrgreg0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def sechydrgreg0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "sechydrgreg0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def sechydrgreg0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "sechydrgreg0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def sechydrgreg0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "sechydrgreg0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def sechydrgreg0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "sechydrgreg0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_sechydrgreg0():
    ...
    load1 = sechydrgreg0_nabu(harvest)
    load2 = sechydrgreg0_nabuprov(load1)
    load3 = sechydrgreg0_nabuorg(load2)
    load4 = sechydrgreg0_naburelease(load3)
