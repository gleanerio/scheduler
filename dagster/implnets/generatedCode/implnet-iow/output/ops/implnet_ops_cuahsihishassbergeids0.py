...
def cuahsihishassbergeids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihishassbergeids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihishassbergeids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihishassbergeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihishassbergeids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihishassbergeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihishassbergeids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihishassbergeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihishassbergeids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihishassbergeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihishassbergeids0():
    ...
    load1 = cuahsihishassbergeids0_nabu(harvest)
    load2 = cuahsihishassbergeids0_nabuprov(load1)
    load3 = cuahsihishassbergeids0_nabuorg(load2)
    load4 = cuahsihishassbergeids0_naburelease(load3)
