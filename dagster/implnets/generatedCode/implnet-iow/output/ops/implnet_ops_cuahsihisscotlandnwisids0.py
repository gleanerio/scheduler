...
@op
def cuahsihisscotlandnwisids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihisscotlandnwisids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisscotlandnwisids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihisscotlandnwisids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisscotlandnwisids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihisscotlandnwisids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisscotlandnwisids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihisscotlandnwisids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihisscotlandnwisids0_uploadrelease(context, msg: str):
...
@op
def cuahsihisscotlandnwisids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisscotlandnwisids0")
    ...
    return msg + r
@op
def cuahsihisscotlandnwisids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisscotlandnwisids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihisscotlandnwisids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisscotlandnwisids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihisscotlandnwisids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihisscotlandnwisids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisscotlandnwisids0"
...
def cuahsihisscotlandnwisids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihisscotlandnwisids0"
...
def harvest_cuahsihisscotlandnwisids0():
    harvest = cuahsihisscotlandnwisids0_gleaner()

    report_ms3 = cuahsihisscotlandnwisids0_missingreport_s3(harvest)
    report_idstat = cuahsihisscotlandnwisids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihisscotlandnwisids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihisscotlandnwisids0")
    load_release = cuahsihisscotlandnwisids0_naburelease(harvest)
    load_uploadrelease = cuahsihisscotlandnwisids0_uploadrelease(load_release)

    load_prune = cuahsihisscotlandnwisids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihisscotlandnwisids0_nabuprov(load_prune)
    load_org = cuahsihisscotlandnwisids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihisscotlandnwisids0_missingreport_graph(load_org)
    report_graph=cuahsihisscotlandnwisids0_graph_reports(report_msgraph)
