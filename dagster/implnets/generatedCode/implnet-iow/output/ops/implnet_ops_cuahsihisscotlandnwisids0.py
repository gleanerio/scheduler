...
def cuahsihisscotlandnwisids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisscotlandnwisids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisscotlandnwisids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisscotlandnwisids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisscotlandnwisids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisscotlandnwisids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisscotlandnwisids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisscotlandnwisids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisscotlandnwisids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisscotlandnwisids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisscotlandnwisids0():
    ...
    load1 = cuahsihisscotlandnwisids0_nabu(harvest)
    load2 = cuahsihisscotlandnwisids0_nabuprov(load1)
    load3 = cuahsihisscotlandnwisids0_nabuorg(load2)
    load4 = cuahsihisscotlandnwisids0_naburelease(load3)
