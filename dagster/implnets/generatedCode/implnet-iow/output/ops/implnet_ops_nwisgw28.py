...
def nwisgw28_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw28")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw28_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw28")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw28_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw28")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw28_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw28")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw28_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw28")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw28():
    ...
    load1 = nwisgw28_nabu(harvest)
    load2 = nwisgw28_nabuprov(load1)
    load3 = nwisgw28_nabuorg(load2)
    load4 = nwisgw28_naburelease(load3)
