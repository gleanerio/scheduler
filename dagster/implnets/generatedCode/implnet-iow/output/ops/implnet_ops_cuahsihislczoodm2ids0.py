...
@op
def cuahsihislczoodm2ids0_nabu_prune(context, msg: str):
    returned_value = gleanerio(context,("nabu"), "cuahsihislczoodm2ids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislczoodm2ids0_nabuprov(context, msg: str):
    returned_value = gleanerio(context,("prov"), "cuahsihislczoodm2ids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislczoodm2ids0_nabuorg(context, msg: str):
    returned_value = gleanerio(context,("orgs"), "cuahsihislczoodm2ids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihislczoodm2ids0_naburelease(context, msg: str):
    returned_value = gleanerio(context,("release"), "cuahsihislczoodm2ids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
@op
def cuahsihislczoodm2ids0_uploadrelease(context, msg: str):
...
@op
def cuahsihislczoodm2ids0_missingreport_s3(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihislczoodm2ids0")
    ...
    return msg + r
@op
def cuahsihislczoodm2ids0_missingreport_graph(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihislczoodm2ids0")
    source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    ...
    return msg + r
@op
def cuahsihislczoodm2ids0_graph_reports(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihislczoodm2ids0")
    #source_url = source.get('url')
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
...
@op
def cuahsihislczoodm2ids0_identifier_stats(context, msg: str):
    source = getSitemapSourcesFromGleaner("/scheduler/gleanerconfig.yaml", sourcename="cuahsihislczoodm2ids0")
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihislczoodm2ids0"
...
def cuahsihislczoodm2ids0_bucket_urls(context, msg: str):
    s3Minio = s3.MinioDatastore(_pythonMinioUrl(GLEANER_MINIO_ADDRESS), None)
    bucket = GLEANER_MINIO_BUCKET
    source_name = "cuahsihislczoodm2ids0"
...
def harvest_cuahsihislczoodm2ids0():
    harvest = cuahsihislczoodm2ids0_gleaner()

    report_ms3 = cuahsihislczoodm2ids0_missingreport_s3(harvest)
    report_idstat = cuahsihislczoodm2ids0_identifier_stats(report_ms3)
    # for some reason, this causes a msg parameter missing
   # report_bucketurl = cuahsihislczoodm2ids0_bucket_urls(report_idstat)

    #report1 = missingreport_s3(harvest, source="cuahsihislczoodm2ids0")
    load_release = cuahsihislczoodm2ids0_naburelease(harvest)
    load_uploadrelease = cuahsihislczoodm2ids0_uploadrelease(load_release)

    load_prune = cuahsihislczoodm2ids0_nabu_prune(load_uploadrelease)
    load_prov = cuahsihislczoodm2ids0_nabuprov(load_prune)
    load_org = cuahsihislczoodm2ids0_nabuorg(load_prov)

# run after load
    report_msgraph=cuahsihislczoodm2ids0_missingreport_graph(load_org)
    report_graph=cuahsihislczoodm2ids0_graph_reports(report_msgraph)
