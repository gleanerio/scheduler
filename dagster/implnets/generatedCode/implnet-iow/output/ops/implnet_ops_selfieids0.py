...
def selfieids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "selfieids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def selfieids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "selfieids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def selfieids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "selfieids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def selfieids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "selfieids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def selfieids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "selfieids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_selfieids0():
    ...
    load1 = selfieids0_nabu(harvest)
    load2 = selfieids0_nabuprov(load1)
    load3 = selfieids0_nabuorg(load2)
    load4 = selfieids0_naburelease(load3)
