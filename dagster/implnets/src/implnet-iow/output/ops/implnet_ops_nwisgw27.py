...
def nwisgw27_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw27")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw27_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw27")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw27_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw27")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw27_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw27")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw27_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw27")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw27():
    ...
    load1 = nwisgw27_nabu(harvest)
    load2 = nwisgw27_nabuprov(load1)
    load3 = nwisgw27_nabuorg(load2)
    load4 = nwisgw27_naburelease(load3)
