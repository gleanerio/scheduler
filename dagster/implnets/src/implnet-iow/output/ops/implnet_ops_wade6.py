...
def wade6_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade6")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade6_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade6")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade6_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade6")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade6_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade6")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade6_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade6")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade6():
    ...
    load1 = wade6_nabu(harvest)
    load2 = wade6_nabuprov(load1)
    load3 = wade6_nabuorg(load2)
    load4 = wade6_naburelease(load3)
