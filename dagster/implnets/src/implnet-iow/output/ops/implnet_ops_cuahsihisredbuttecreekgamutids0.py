...
def cuahsihisredbuttecreekgamutids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisredbuttecreekgamutids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisredbuttecreekgamutids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisredbuttecreekgamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisredbuttecreekgamutids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisredbuttecreekgamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisredbuttecreekgamutids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisredbuttecreekgamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisredbuttecreekgamutids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisredbuttecreekgamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisredbuttecreekgamutids0():
    ...
    load1 = cuahsihisredbuttecreekgamutids0_nabu(harvest)
    load2 = cuahsihisredbuttecreekgamutids0_nabuprov(load1)
    load3 = cuahsihisredbuttecreekgamutids0_nabuorg(load2)
    load4 = cuahsihisredbuttecreekgamutids0_naburelease(load3)
