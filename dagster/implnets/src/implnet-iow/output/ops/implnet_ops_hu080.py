...
def hu080_gleaner(context):
    returned_value = gleanerio(("gleaner"), "hu080")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def hu080_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "hu080")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu080_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "hu080")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu080_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "hu080")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu080_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "hu080")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_hu080():
    ...
    load1 = hu080_nabu(harvest)
    load2 = hu080_nabuprov(load1)
    load3 = hu080_nabuorg(load2)
    load4 = hu080_naburelease(load3)
