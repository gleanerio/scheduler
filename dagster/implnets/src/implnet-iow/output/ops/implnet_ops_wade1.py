...
def wade1_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade1")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade1_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade1_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade1_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade1_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade1():
    ...
    load1 = wade1_nabu(harvest)
    load2 = wade1_nabuprov(load1)
    load3 = wade1_nabuorg(load2)
    load4 = wade1_naburelease(load3)
