...
def nwisgw13_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw13")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw13_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw13")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw13_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw13")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw13_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw13")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw13_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw13")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw13():
    ...
    load1 = nwisgw13_nabu(harvest)
    load2 = nwisgw13_nabuprov(load1)
    load3 = nwisgw13_nabuorg(load2)
    load4 = nwisgw13_naburelease(load3)
