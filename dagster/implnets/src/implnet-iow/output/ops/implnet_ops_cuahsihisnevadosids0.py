...
def cuahsihisnevadosids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisnevadosids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisnevadosids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisnevadosids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnevadosids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisnevadosids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnevadosids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisnevadosids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnevadosids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisnevadosids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisnevadosids0():
    ...
    load1 = cuahsihisnevadosids0_nabu(harvest)
    load2 = cuahsihisnevadosids0_nabuprov(load1)
    load3 = cuahsihisnevadosids0_nabuorg(load2)
    load4 = cuahsihisnevadosids0_naburelease(load3)
