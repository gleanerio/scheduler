...
def cagagespids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cagagespids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cagagespids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cagagespids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cagagespids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cagagespids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cagagespids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cagagespids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cagagespids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cagagespids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cagagespids0():
    ...
    load1 = cagagespids0_nabu(harvest)
    load2 = cagagespids0_nabuprov(load1)
    load3 = cagagespids0_nabuorg(load2)
    load4 = cagagespids0_naburelease(load3)
