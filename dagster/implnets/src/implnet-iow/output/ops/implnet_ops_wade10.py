...
def wade10_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade10")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade10_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade10")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade10_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade10")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade10_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade10")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade10_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade10")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade10():
    ...
    load1 = wade10_nabu(harvest)
    load2 = wade10_nabuprov(load1)
    load3 = wade10_nabuorg(load2)
    load4 = wade10_naburelease(load3)
