...
def dams1_gleaner(context):
    returned_value = gleanerio(("gleaner"), "dams1")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def dams1_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "dams1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def dams1_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "dams1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def dams1_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "dams1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def dams1_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "dams1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_dams1():
    ...
    load1 = dams1_nabu(harvest)
    load2 = dams1_nabuprov(load1)
    load3 = dams1_nabuorg(load2)
    load4 = dams1_naburelease(load3)
