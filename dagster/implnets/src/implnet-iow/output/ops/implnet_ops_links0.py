...
def links0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "links0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def links0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "links0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def links0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "links0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def links0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "links0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def links0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "links0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_links0():
    ...
    load1 = links0_nabu(harvest)
    load2 = links0_nabuprov(load1)
    load3 = links0_nabuorg(load2)
    load4 = links0_naburelease(load3)
