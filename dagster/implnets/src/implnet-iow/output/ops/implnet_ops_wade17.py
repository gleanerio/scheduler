...
def wade17_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade17")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade17_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade17")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade17_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade17")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade17_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade17")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade17_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade17")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade17():
    ...
    load1 = wade17_nabu(harvest)
    load2 = wade17_nabuprov(load1)
    load3 = wade17_nabuorg(load2)
    load4 = wade17_naburelease(load3)
