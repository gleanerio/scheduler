...
def cuahsihisparalanaturalezaids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisparalanaturalezaids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisparalanaturalezaids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisparalanaturalezaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisparalanaturalezaids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisparalanaturalezaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisparalanaturalezaids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisparalanaturalezaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisparalanaturalezaids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisparalanaturalezaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisparalanaturalezaids0():
    ...
    load1 = cuahsihisparalanaturalezaids0_nabu(harvest)
    load2 = cuahsihisparalanaturalezaids0_nabuprov(load1)
    load3 = cuahsihisparalanaturalezaids0_nabuorg(load2)
    load4 = cuahsihisparalanaturalezaids0_naburelease(load3)
