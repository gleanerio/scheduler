...
def cbsa0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cbsa0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cbsa0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cbsa0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cbsa0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cbsa0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cbsa0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cbsa0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cbsa0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cbsa0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cbsa0():
    ...
    load1 = cbsa0_nabu(harvest)
    load2 = cbsa0_nabuprov(load1)
    load3 = cbsa0_nabuorg(load2)
    load4 = cbsa0_naburelease(load3)
