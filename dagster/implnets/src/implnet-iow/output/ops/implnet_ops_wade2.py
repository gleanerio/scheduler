...
def wade2_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade2")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade2_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade2_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade2_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade2_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade2():
    ...
    load1 = wade2_nabu(harvest)
    load2 = wade2_nabuprov(load1)
    load3 = wade2_nabuorg(load2)
    load4 = wade2_naburelease(load3)
