...
def hu060_gleaner(context):
    returned_value = gleanerio(("gleaner"), "hu060")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def hu060_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "hu060")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu060_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "hu060")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu060_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "hu060")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu060_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "hu060")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_hu060():
    ...
    load1 = hu060_nabu(harvest)
    load2 = hu060_nabuprov(load1)
    load3 = hu060_nabuorg(load2)
    load4 = hu060_naburelease(load3)
