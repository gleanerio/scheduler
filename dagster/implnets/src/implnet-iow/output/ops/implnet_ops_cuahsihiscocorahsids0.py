...
def cuahsihiscocorahsids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihiscocorahsids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihiscocorahsids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihiscocorahsids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiscocorahsids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihiscocorahsids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiscocorahsids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihiscocorahsids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihiscocorahsids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihiscocorahsids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihiscocorahsids0():
    ...
    load1 = cuahsihiscocorahsids0_nabu(harvest)
    load2 = cuahsihiscocorahsids0_nabuprov(load1)
    load3 = cuahsihiscocorahsids0_nabuorg(load2)
    load4 = cuahsihiscocorahsids0_naburelease(load3)
