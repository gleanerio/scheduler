...
def wade0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade0():
    ...
    load1 = wade0_nabu(harvest)
    load2 = wade0_nabuprov(load1)
    load3 = wade0_nabuorg(load2)
    load4 = wade0_naburelease(load3)
