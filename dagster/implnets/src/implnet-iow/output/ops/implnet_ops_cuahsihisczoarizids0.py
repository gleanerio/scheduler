...
def cuahsihisczoarizids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisczoarizids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisczoarizids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisczoarizids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczoarizids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisczoarizids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczoarizids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisczoarizids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczoarizids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisczoarizids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisczoarizids0():
    ...
    load1 = cuahsihisczoarizids0_nabu(harvest)
    load2 = cuahsihisczoarizids0_nabuprov(load1)
    load3 = cuahsihisczoarizids0_nabuorg(load2)
    load4 = cuahsihisczoarizids0_naburelease(load3)
