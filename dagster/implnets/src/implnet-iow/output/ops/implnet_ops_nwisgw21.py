...
def nwisgw21_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw21")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw21_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw21")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw21_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw21")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw21_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw21")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw21_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw21")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw21():
    ...
    load1 = nwisgw21_nabu(harvest)
    load2 = nwisgw21_nabuprov(load1)
    load3 = nwisgw21_nabuorg(load2)
    load4 = nwisgw21_naburelease(load3)
