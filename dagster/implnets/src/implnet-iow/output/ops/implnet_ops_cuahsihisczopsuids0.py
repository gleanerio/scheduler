...
def cuahsihisczopsuids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisczopsuids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisczopsuids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisczopsuids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczopsuids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisczopsuids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczopsuids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisczopsuids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczopsuids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisczopsuids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisczopsuids0():
    ...
    load1 = cuahsihisczopsuids0_nabu(harvest)
    load2 = cuahsihisczopsuids0_nabuprov(load1)
    load3 = cuahsihisczopsuids0_nabuorg(load2)
    load4 = cuahsihisczopsuids0_naburelease(load3)
