...
def autotest10_gleaner(context):
    returned_value = gleanerio(("gleaner"), "autotest10")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def autotest10_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "autotest10")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def autotest10_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "autotest10")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def autotest10_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "autotest10")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def autotest10_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "autotest10")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_autotest10():
    ...
    load1 = autotest10_nabu(harvest)
    load2 = autotest10_nabuprov(load1)
    load3 = autotest10_nabuorg(load2)
    load4 = autotest10_naburelease(load3)
