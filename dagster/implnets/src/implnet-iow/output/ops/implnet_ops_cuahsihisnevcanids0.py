...
def cuahsihisnevcanids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisnevcanids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisnevcanids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisnevcanids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnevcanids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisnevcanids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnevcanids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisnevcanids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnevcanids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisnevcanids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisnevcanids0():
    ...
    load1 = cuahsihisnevcanids0_nabu(harvest)
    load2 = cuahsihisnevcanids0_nabuprov(load1)
    load3 = cuahsihisnevcanids0_nabuorg(load2)
    load4 = cuahsihisnevcanids0_naburelease(load3)
