...
def nwissite2_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwissite2")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwissite2_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwissite2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwissite2_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwissite2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwissite2_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwissite2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwissite2_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwissite2")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwissite2():
    ...
    load1 = nwissite2_nabu(harvest)
    load2 = nwissite2_nabuprov(load1)
    load3 = nwissite2_nabuorg(load2)
    load4 = nwissite2_naburelease(load3)
