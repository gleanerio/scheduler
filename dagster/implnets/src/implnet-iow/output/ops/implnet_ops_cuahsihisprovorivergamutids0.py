...
def cuahsihisprovorivergamutids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisprovorivergamutids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisprovorivergamutids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisprovorivergamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisprovorivergamutids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisprovorivergamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisprovorivergamutids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisprovorivergamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisprovorivergamutids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisprovorivergamutids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisprovorivergamutids0():
    ...
    load1 = cuahsihisprovorivergamutids0_nabu(harvest)
    load2 = cuahsihisprovorivergamutids0_nabuprov(load1)
    load3 = cuahsihisprovorivergamutids0_nabuorg(load2)
    load4 = cuahsihisprovorivergamutids0_naburelease(load3)
