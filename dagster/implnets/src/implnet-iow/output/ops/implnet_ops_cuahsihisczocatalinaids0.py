...
def cuahsihisczocatalinaids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisczocatalinaids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisczocatalinaids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisczocatalinaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczocatalinaids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisczocatalinaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczocatalinaids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisczocatalinaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczocatalinaids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisczocatalinaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisczocatalinaids0():
    ...
    load1 = cuahsihisczocatalinaids0_nabu(harvest)
    load2 = cuahsihisczocatalinaids0_nabuprov(load1)
    load3 = cuahsihisczocatalinaids0_nabuorg(load2)
    load4 = cuahsihisczocatalinaids0_naburelease(load3)
