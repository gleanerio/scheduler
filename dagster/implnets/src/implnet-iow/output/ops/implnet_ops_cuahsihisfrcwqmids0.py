...
def cuahsihisfrcwqmids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisfrcwqmids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisfrcwqmids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisfrcwqmids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisfrcwqmids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisfrcwqmids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisfrcwqmids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisfrcwqmids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisfrcwqmids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisfrcwqmids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisfrcwqmids0():
    ...
    load1 = cuahsihisfrcwqmids0_nabu(harvest)
    load2 = cuahsihisfrcwqmids0_nabuprov(load1)
    load3 = cuahsihisfrcwqmids0_nabuorg(load2)
    load4 = cuahsihisfrcwqmids0_naburelease(load3)
