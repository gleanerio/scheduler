...
def nwisgw10_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw10")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw10_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw10")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw10_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw10")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw10_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw10")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw10_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw10")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw10():
    ...
    load1 = nwisgw10_nabu(harvest)
    load2 = nwisgw10_nabuprov(load1)
    load3 = nwisgw10_nabuorg(load2)
    load4 = nwisgw10_naburelease(load3)
