...
def nmwdist0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nmwdist0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nmwdist0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nmwdist0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdist0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nmwdist0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdist0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nmwdist0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdist0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nmwdist0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nmwdist0():
    ...
    load1 = nmwdist0_nabu(harvest)
    load2 = nmwdist0_nabuprov(load1)
    load3 = nmwdist0_nabuorg(load2)
    load4 = nmwdist0_naburelease(load3)
