...
def cuahsihisczomercedids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisczomercedids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisczomercedids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisczomercedids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczomercedids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisczomercedids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczomercedids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisczomercedids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisczomercedids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisczomercedids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisczomercedids0():
    ...
    load1 = cuahsihisczomercedids0_nabu(harvest)
    load2 = cuahsihisczomercedids0_nabuprov(load1)
    load3 = cuahsihisczomercedids0_nabuorg(load2)
    load4 = cuahsihisczomercedids0_naburelease(load3)
