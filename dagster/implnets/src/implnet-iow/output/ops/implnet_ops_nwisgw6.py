...
def nwisgw6_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw6")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw6_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw6")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw6_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw6")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw6_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw6")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw6_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw6")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw6():
    ...
    load1 = nwisgw6_nabu(harvest)
    load2 = nwisgw6_nabuprov(load1)
    load3 = nwisgw6_nabuorg(load2)
    load4 = nwisgw6_naburelease(load3)
