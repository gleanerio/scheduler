...
def refgage3_gleaner(context):
    returned_value = gleanerio(("gleaner"), "refgage3")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def refgage3_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "refgage3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def refgage3_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "refgage3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def refgage3_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "refgage3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def refgage3_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "refgage3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_refgage3():
    ...
    load1 = refgage3_nabu(harvest)
    load2 = refgage3_nabuprov(load1)
    load3 = refgage3_nabuorg(load2)
    load4 = refgage3_naburelease(load3)
