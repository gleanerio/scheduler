...
def cuahsihisclarksburgspids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisclarksburgspids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisclarksburgspids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisclarksburgspids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisclarksburgspids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisclarksburgspids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisclarksburgspids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisclarksburgspids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisclarksburgspids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisclarksburgspids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisclarksburgspids0():
    ...
    load1 = cuahsihisclarksburgspids0_nabu(harvest)
    load2 = cuahsihisclarksburgspids0_nabuprov(load1)
    load3 = cuahsihisclarksburgspids0_nabuorg(load2)
    load4 = cuahsihisclarksburgspids0_naburelease(load3)
