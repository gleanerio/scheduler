...
def wade9_gleaner(context):
    returned_value = gleanerio(("gleaner"), "wade9")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def wade9_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "wade9")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade9_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "wade9")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade9_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "wade9")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def wade9_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "wade9")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_wade9():
    ...
    load1 = wade9_nabu(harvest)
    load2 = wade9_nabuprov(load1)
    load3 = wade9_nabuorg(load2)
    load4 = wade9_naburelease(load3)
