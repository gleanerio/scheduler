...
def cuahsihisgleonauburnids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisgleonauburnids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisgleonauburnids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisgleonauburnids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonauburnids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisgleonauburnids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonauburnids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisgleonauburnids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisgleonauburnids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisgleonauburnids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisgleonauburnids0():
    ...
    load1 = cuahsihisgleonauburnids0_nabu(harvest)
    load2 = cuahsihisgleonauburnids0_nabuprov(load1)
    load3 = cuahsihisgleonauburnids0_nabuorg(load2)
    load4 = cuahsihisgleonauburnids0_naburelease(load3)
