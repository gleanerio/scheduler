...
def cuahsihisnashrwaids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisnashrwaids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisnashrwaids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisnashrwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnashrwaids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisnashrwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnashrwaids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisnashrwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisnashrwaids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisnashrwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisnashrwaids0():
    ...
    load1 = cuahsihisnashrwaids0_nabu(harvest)
    load2 = cuahsihisnashrwaids0_nabuprov(load1)
    load3 = cuahsihisnashrwaids0_nabuorg(load2)
    load4 = cuahsihisnashrwaids0_naburelease(load3)
