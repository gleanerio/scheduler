...
def cuahsihisodmkentstateids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisodmkentstateids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisodmkentstateids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisodmkentstateids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisodmkentstateids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisodmkentstateids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisodmkentstateids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisodmkentstateids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisodmkentstateids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisodmkentstateids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisodmkentstateids0():
    ...
    load1 = cuahsihisodmkentstateids0_nabu(harvest)
    load2 = cuahsihisodmkentstateids0_nabuprov(load1)
    load3 = cuahsihisodmkentstateids0_nabuorg(load2)
    load4 = cuahsihisodmkentstateids0_naburelease(load3)
