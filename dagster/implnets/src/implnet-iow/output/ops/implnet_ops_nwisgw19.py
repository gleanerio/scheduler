...
def nwisgw19_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw19")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw19_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw19")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw19_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw19")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw19_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw19")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw19_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw19")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw19():
    ...
    load1 = nwisgw19_nabu(harvest)
    load2 = nwisgw19_nabuprov(load1)
    load3 = nwisgw19_nabuorg(load2)
    load4 = nwisgw19_naburelease(load3)
