...
def nwissite1_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwissite1")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwissite1_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwissite1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwissite1_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwissite1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwissite1_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwissite1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwissite1_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwissite1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwissite1():
    ...
    load1 = nwissite1_nabu(harvest)
    load2 = nwissite1_nabuprov(load1)
    load3 = nwissite1_nabuorg(load2)
    load4 = nwissite1_naburelease(load3)
