...
def nwisgw4_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw4")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw4_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw4")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw4_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw4")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw4_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw4")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw4_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw4")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw4():
    ...
    load1 = nwisgw4_nabu(harvest)
    load2 = nwisgw4_nabuprov(load1)
    load3 = nwisgw4_nabuorg(load2)
    load4 = nwisgw4_naburelease(load3)
