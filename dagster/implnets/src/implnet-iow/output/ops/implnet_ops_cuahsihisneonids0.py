...
def cuahsihisneonids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisneonids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisneonids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisneonids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisneonids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisneonids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisneonids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisneonids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisneonids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisneonids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisneonids0():
    ...
    load1 = cuahsihisneonids0_nabu(harvest)
    load2 = cuahsihisneonids0_nabuprov(load1)
    load3 = cuahsihisneonids0_nabuorg(load2)
    load4 = cuahsihisneonids0_naburelease(load3)
