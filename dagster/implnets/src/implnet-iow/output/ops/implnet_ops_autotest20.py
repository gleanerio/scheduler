...
def autotest20_gleaner(context):
    returned_value = gleanerio(("gleaner"), "autotest20")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def autotest20_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "autotest20")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def autotest20_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "autotest20")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def autotest20_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "autotest20")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def autotest20_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "autotest20")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_autotest20():
    ...
    load1 = autotest20_nabu(harvest)
    load2 = autotest20_nabuprov(load1)
    load3 = autotest20_nabuorg(load2)
    load4 = autotest20_naburelease(load3)
