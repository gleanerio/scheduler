...
def nwisgw9_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw9")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw9_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw9")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw9_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw9")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw9_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw9")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw9_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw9")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw9():
    ...
    load1 = nwisgw9_nabu(harvest)
    load2 = nwisgw9_nabuprov(load1)
    load3 = nwisgw9_nabuorg(load2)
    load4 = nwisgw9_naburelease(load3)
