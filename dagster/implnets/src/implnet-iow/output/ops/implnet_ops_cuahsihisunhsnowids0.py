...
def cuahsihisunhsnowids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisunhsnowids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisunhsnowids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisunhsnowids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisunhsnowids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisunhsnowids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisunhsnowids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisunhsnowids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisunhsnowids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisunhsnowids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisunhsnowids0():
    ...
    load1 = cuahsihisunhsnowids0_nabu(harvest)
    load2 = cuahsihisunhsnowids0_nabuprov(load1)
    load3 = cuahsihisunhsnowids0_nabuorg(load2)
    load4 = cuahsihisunhsnowids0_naburelease(load3)
