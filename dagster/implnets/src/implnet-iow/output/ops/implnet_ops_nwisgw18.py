...
def nwisgw18_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw18")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw18_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw18")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw18_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw18")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw18_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw18")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw18_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw18")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw18():
    ...
    load1 = nwisgw18_nabu(harvest)
    load2 = nwisgw18_nabuprov(load1)
    load3 = nwisgw18_nabuorg(load2)
    load4 = nwisgw18_naburelease(load3)
