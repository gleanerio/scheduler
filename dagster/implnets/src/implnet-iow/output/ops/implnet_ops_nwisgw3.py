...
def nwisgw3_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw3")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw3_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw3_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw3_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw3_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw3")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw3():
    ...
    load1 = nwisgw3_nabu(harvest)
    load2 = nwisgw3_nabuprov(load1)
    load3 = nwisgw3_nabuorg(load2)
    load4 = nwisgw3_naburelease(load3)
