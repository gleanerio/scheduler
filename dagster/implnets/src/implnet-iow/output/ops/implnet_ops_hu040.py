...
def hu040_gleaner(context):
    returned_value = gleanerio(("gleaner"), "hu040")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def hu040_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "hu040")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu040_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "hu040")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu040_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "hu040")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hu040_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "hu040")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_hu040():
    ...
    load1 = hu040_nabu(harvest)
    load2 = hu040_nabuprov(load1)
    load3 = hu040_nabuorg(load2)
    load4 = hu040_naburelease(load3)
