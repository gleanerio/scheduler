...
def cuahsihistncwaterdataids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihistncwaterdataids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihistncwaterdataids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihistncwaterdataids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihistncwaterdataids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihistncwaterdataids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihistncwaterdataids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihistncwaterdataids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihistncwaterdataids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihistncwaterdataids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihistncwaterdataids0():
    ...
    load1 = cuahsihistncwaterdataids0_nabu(harvest)
    load2 = cuahsihistncwaterdataids0_nabuprov(load1)
    load3 = cuahsihistncwaterdataids0_nabuorg(load2)
    load4 = cuahsihistncwaterdataids0_naburelease(load3)
