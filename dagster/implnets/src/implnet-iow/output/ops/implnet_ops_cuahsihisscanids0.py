...
def cuahsihisscanids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisscanids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisscanids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisscanids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisscanids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisscanids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisscanids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisscanids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisscanids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisscanids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisscanids0():
    ...
    load1 = cuahsihisscanids0_nabu(harvest)
    load2 = cuahsihisscanids0_nabuprov(load1)
    load3 = cuahsihisscanids0_nabuorg(load2)
    load4 = cuahsihisscanids0_naburelease(load3)
