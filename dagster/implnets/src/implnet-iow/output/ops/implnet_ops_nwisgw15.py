...
def nwisgw15_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw15")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw15_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw15")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw15_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw15")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw15_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw15")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw15_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw15")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw15():
    ...
    load1 = nwisgw15_nabu(harvest)
    load2 = nwisgw15_nabuprov(load1)
    load3 = nwisgw15_nabuorg(load2)
    load4 = nwisgw15_naburelease(load3)
