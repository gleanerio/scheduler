...
def pws0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "pws0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def pws0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "pws0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def pws0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "pws0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def pws0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "pws0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def pws0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "pws0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_pws0():
    ...
    load1 = pws0_nabu(harvest)
    load2 = pws0_nabuprov(load1)
    load3 = pws0_nabuorg(load2)
    load4 = pws0_naburelease(load3)
