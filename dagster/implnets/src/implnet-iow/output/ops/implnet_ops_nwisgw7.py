...
def nwisgw7_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw7")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw7_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw7")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw7_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw7")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw7_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw7")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw7_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw7")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw7():
    ...
    load1 = nwisgw7_nabu(harvest)
    load2 = nwisgw7_nabuprov(load1)
    load3 = nwisgw7_nabuorg(load2)
    load4 = nwisgw7_naburelease(load3)
