...
def cuahsihisfcelterids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisfcelterids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisfcelterids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisfcelterids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisfcelterids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisfcelterids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisfcelterids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisfcelterids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisfcelterids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisfcelterids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisfcelterids0():
    ...
    load1 = cuahsihisfcelterids0_nabu(harvest)
    load2 = cuahsihisfcelterids0_nabuprov(load1)
    load3 = cuahsihisfcelterids0_nabuorg(load2)
    load4 = cuahsihisfcelterids0_naburelease(load3)
