...
def refgage1_gleaner(context):
    returned_value = gleanerio(("gleaner"), "refgage1")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def refgage1_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "refgage1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def refgage1_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "refgage1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def refgage1_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "refgage1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def refgage1_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "refgage1")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_refgage1():
    ...
    load1 = refgage1_nabu(harvest)
    load2 = refgage1_nabuprov(load1)
    load3 = refgage1_nabuorg(load2)
    load4 = refgage1_naburelease(load3)
