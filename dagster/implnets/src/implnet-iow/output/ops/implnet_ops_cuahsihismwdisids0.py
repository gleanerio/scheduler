...
def cuahsihismwdisids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihismwdisids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihismwdisids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihismwdisids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismwdisids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihismwdisids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismwdisids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihismwdisids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihismwdisids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihismwdisids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihismwdisids0():
    ...
    load1 = cuahsihismwdisids0_nabu(harvest)
    load2 = cuahsihismwdisids0_nabuprov(load1)
    load3 = cuahsihismwdisids0_nabuorg(load2)
    load4 = cuahsihismwdisids0_naburelease(load3)
