...
def hydrologicunit0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "hydrologicunit0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def hydrologicunit0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "hydrologicunit0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hydrologicunit0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "hydrologicunit0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hydrologicunit0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "hydrologicunit0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def hydrologicunit0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "hydrologicunit0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_hydrologicunit0():
    ...
    load1 = hydrologicunit0_nabu(harvest)
    load2 = hydrologicunit0_nabuprov(load1)
    load3 = hydrologicunit0_nabuorg(load2)
    load4 = hydrologicunit0_naburelease(load3)
