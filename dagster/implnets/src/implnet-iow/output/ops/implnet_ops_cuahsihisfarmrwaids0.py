...
def cuahsihisfarmrwaids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisfarmrwaids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisfarmrwaids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisfarmrwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisfarmrwaids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisfarmrwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisfarmrwaids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisfarmrwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisfarmrwaids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisfarmrwaids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisfarmrwaids0():
    ...
    load1 = cuahsihisfarmrwaids0_nabu(harvest)
    load2 = cuahsihisfarmrwaids0_nabuprov(load1)
    load3 = cuahsihisfarmrwaids0_nabuorg(load2)
    load4 = cuahsihisfarmrwaids0_naburelease(load3)
