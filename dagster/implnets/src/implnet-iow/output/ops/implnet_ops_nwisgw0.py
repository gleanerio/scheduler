...
def nwisgw0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw0():
    ...
    load1 = nwisgw0_nabu(harvest)
    load2 = nwisgw0_nabuprov(load1)
    load3 = nwisgw0_nabuorg(load2)
    load4 = nwisgw0_naburelease(load3)
