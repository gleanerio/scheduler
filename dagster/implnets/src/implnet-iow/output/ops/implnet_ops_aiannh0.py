...
def aiannh0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "aiannh0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def aiannh0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "aiannh0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def aiannh0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "aiannh0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def aiannh0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "aiannh0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def aiannh0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "aiannh0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_aiannh0():
    ...
    load1 = aiannh0_nabu(harvest)
    load2 = aiannh0_nabuprov(load1)
    load3 = aiannh0_nabuorg(load2)
    load4 = aiannh0_naburelease(load3)
