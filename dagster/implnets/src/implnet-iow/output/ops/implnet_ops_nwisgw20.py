...
def nwisgw20_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw20")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw20_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw20")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw20_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw20")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw20_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw20")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw20_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw20")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw20():
    ...
    load1 = nwisgw20_nabu(harvest)
    load2 = nwisgw20_nabuprov(load1)
    load3 = nwisgw20_nabuorg(load2)
    load4 = nwisgw20_naburelease(load3)
