...
def mainstems0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "mainstems0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def mainstems0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "mainstems0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def mainstems0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "mainstems0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def mainstems0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "mainstems0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def mainstems0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "mainstems0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_mainstems0():
    ...
    load1 = mainstems0_nabu(harvest)
    load2 = mainstems0_nabuprov(load1)
    load3 = mainstems0_nabuorg(load2)
    load4 = mainstems0_naburelease(load3)
