...
def nwisgw23_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw23")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw23_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw23")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw23_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw23")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw23_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw23")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw23_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw23")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw23():
    ...
    load1 = nwisgw23_nabu(harvest)
    load2 = nwisgw23_nabuprov(load1)
    load3 = nwisgw23_nabuorg(load2)
    load4 = nwisgw23_naburelease(load3)
