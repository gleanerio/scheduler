...
def cuahsihisandrewsforestlterids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisandrewsforestlterids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisandrewsforestlterids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisandrewsforestlterids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisandrewsforestlterids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisandrewsforestlterids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisandrewsforestlterids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisandrewsforestlterids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisandrewsforestlterids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisandrewsforestlterids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisandrewsforestlterids0():
    ...
    load1 = cuahsihisandrewsforestlterids0_nabu(harvest)
    load2 = cuahsihisandrewsforestlterids0_nabuprov(load1)
    load3 = cuahsihisandrewsforestlterids0_nabuorg(load2)
    load4 = cuahsihisandrewsforestlterids0_naburelease(load3)
