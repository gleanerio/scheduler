...
def cuahsihisglacialridgeids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisglacialridgeids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisglacialridgeids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisglacialridgeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisglacialridgeids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisglacialridgeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisglacialridgeids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisglacialridgeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisglacialridgeids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisglacialridgeids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisglacialridgeids0():
    ...
    load1 = cuahsihisglacialridgeids0_nabu(harvest)
    load2 = cuahsihisglacialridgeids0_nabuprov(load1)
    load3 = cuahsihisglacialridgeids0_nabuorg(load2)
    load4 = cuahsihisglacialridgeids0_naburelease(load3)
