...
def cuahsihissnotelids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihissnotelids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihissnotelids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihissnotelids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihissnotelids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihissnotelids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihissnotelids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihissnotelids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihissnotelids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihissnotelids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihissnotelids0():
    ...
    load1 = cuahsihissnotelids0_nabu(harvest)
    load2 = cuahsihissnotelids0_nabuprov(load1)
    load3 = cuahsihissnotelids0_nabuorg(load2)
    load4 = cuahsihissnotelids0_naburelease(load3)
