...
def cuahsihistuolumnemdwids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihistuolumnemdwids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihistuolumnemdwids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihistuolumnemdwids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihistuolumnemdwids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihistuolumnemdwids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihistuolumnemdwids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihistuolumnemdwids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihistuolumnemdwids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihistuolumnemdwids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihistuolumnemdwids0():
    ...
    load1 = cuahsihistuolumnemdwids0_nabu(harvest)
    load2 = cuahsihistuolumnemdwids0_nabuprov(load1)
    load3 = cuahsihistuolumnemdwids0_nabuorg(load2)
    load4 = cuahsihistuolumnemdwids0_naburelease(load3)
