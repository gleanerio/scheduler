...
def damspids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "damspids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def damspids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "damspids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def damspids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "damspids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def damspids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "damspids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def damspids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "damspids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_damspids0():
    ...
    load1 = damspids0_nabu(harvest)
    load2 = damspids0_nabuprov(load1)
    load3 = damspids0_nabuorg(load2)
    load4 = damspids0_naburelease(load3)
