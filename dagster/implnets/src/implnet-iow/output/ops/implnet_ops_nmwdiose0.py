...
def nmwdiose0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nmwdiose0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nmwdiose0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nmwdiose0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nmwdiose0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nmwdiose0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nmwdiose0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nmwdiose0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nmwdiose0():
    ...
    load1 = nmwdiose0_nabu(harvest)
    load2 = nmwdiose0_nabuprov(load1)
    load3 = nmwdiose0_nabuorg(load2)
    load4 = nmwdiose0_naburelease(load3)
