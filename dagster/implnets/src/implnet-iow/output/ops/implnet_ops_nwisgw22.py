...
def nwisgw22_gleaner(context):
    returned_value = gleanerio(("gleaner"), "nwisgw22")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def nwisgw22_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "nwisgw22")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw22_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "nwisgw22")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw22_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "nwisgw22")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def nwisgw22_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "nwisgw22")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_nwisgw22():
    ...
    load1 = nwisgw22_nabu(harvest)
    load2 = nwisgw22_nabuprov(load1)
    load3 = nwisgw22_nabuorg(load2)
    load4 = nwisgw22_naburelease(load3)
