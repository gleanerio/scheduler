...
def cuahsihisrmblids0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsihisrmblids0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsihisrmblids0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsihisrmblids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisrmblids0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "cuahsihisrmblids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisrmblids0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "cuahsihisrmblids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def cuahsihisrmblids0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "cuahsihisrmblids0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_cuahsihisrmblids0():
    ...
    load1 = cuahsihisrmblids0_nabu(harvest)
    load2 = cuahsihisrmblids0_nabuprov(load1)
    load3 = cuahsihisrmblids0_nabuorg(load2)
    load4 = cuahsihisrmblids0_naburelease(load3)
