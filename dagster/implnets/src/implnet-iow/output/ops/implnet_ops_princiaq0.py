...
def princiaq0_gleaner(context):
    returned_value = gleanerio(("gleaner"), "princiaq0")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def princiaq0_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "princiaq0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def princiaq0_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "princiaq0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def princiaq0_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "princiaq0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def princiaq0_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "princiaq0")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_princiaq0():
    ...
    load1 = princiaq0_nabu(harvest)
    load2 = princiaq0_nabuprov(load1)
    load3 = princiaq0_nabuorg(load2)
    load4 = princiaq0_naburelease(load3)
