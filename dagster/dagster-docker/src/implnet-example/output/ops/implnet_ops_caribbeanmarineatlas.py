...
@op
def caribbeanmarineatlas_gleaner():
...
#     returned_value = subprocess.run('./gleaner.bin -cfg gleanerconfig.yaml  --source caribbeanmarineatlas -rude', shell=True, cwd='/usr/src/app')
