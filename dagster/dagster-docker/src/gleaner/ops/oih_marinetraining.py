...
def marinetraining(context):
    returned_value = subprocess.call('./gleanerDocker.sh -cfg /gleaner/wd/rundir/oih_local.json  --source marinetraining', shell=True, cwd='/home/fils/src/gomods/gleaner/secret/dockercli')
