...
@op
def cuahsi158_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi158")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi158_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi158")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi158():
    harvest = cuahsi158_gleaner()
    load1 = cuahsi158_nabu(harvest)
