...
@op
def cuahsi121_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi121")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi121_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi121")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi121():
    harvest = cuahsi121_gleaner()
    load1 = cuahsi121_nabu(harvest)
