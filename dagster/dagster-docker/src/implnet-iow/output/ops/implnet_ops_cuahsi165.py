...
@op
def cuahsi165_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi165")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi165_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi165")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi165():
    harvest = cuahsi165_gleaner()
    load1 = cuahsi165_nabu(harvest)
