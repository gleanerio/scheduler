...
@op
def cuahsi178_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi178")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi178_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi178")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi178():
    harvest = cuahsi178_gleaner()
    load1 = cuahsi178_nabu(harvest)
