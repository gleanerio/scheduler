...
@op
def cuahsi176_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi176")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi176_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi176")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi176():
    harvest = cuahsi176_gleaner()
    load1 = cuahsi176_nabu(harvest)
