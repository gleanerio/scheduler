...
@op
def cuahsi146_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi146")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi146_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi146")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi146():
    harvest = cuahsi146_gleaner()
    load1 = cuahsi146_nabu(harvest)
