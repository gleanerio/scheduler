...
@op
def cuahsi129_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi129")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi129_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi129")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi129():
    harvest = cuahsi129_gleaner()
    load1 = cuahsi129_nabu(harvest)
