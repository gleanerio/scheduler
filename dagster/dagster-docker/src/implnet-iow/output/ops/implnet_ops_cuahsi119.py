...
@op
def cuahsi119_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi119")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi119_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi119")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi119():
    harvest = cuahsi119_gleaner()
    load1 = cuahsi119_nabu(harvest)
