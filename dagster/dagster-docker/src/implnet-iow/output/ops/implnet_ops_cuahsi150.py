...
@op
def cuahsi150_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi150")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi150_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi150")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi150():
    harvest = cuahsi150_gleaner()
    load1 = cuahsi150_nabu(harvest)
