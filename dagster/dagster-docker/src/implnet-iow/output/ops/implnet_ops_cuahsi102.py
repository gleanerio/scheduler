...
@op
def cuahsi102_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi102")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi102_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi102")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi102():
    harvest = cuahsi102_gleaner()
    load1 = cuahsi102_nabu(harvest)
