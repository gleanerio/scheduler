...
@op
def cuahsi149_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi149")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi149_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi149")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi149():
    harvest = cuahsi149_gleaner()
    load1 = cuahsi149_nabu(harvest)
