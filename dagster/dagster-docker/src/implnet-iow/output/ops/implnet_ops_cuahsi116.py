...
@op
def cuahsi116_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi116")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi116_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi116")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi116():
    harvest = cuahsi116_gleaner()
    load1 = cuahsi116_nabu(harvest)
