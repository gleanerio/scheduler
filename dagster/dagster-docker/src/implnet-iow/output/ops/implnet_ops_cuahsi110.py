...
@op
def cuahsi110_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi110")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi110_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi110")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi110():
    harvest = cuahsi110_gleaner()
    load1 = cuahsi110_nabu(harvest)
