...
@op
def ref39_gleaner(context):
    returned_value = gleanerio(("gleaner"), "ref39")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def ref39_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "ref39")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_ref39():
    harvest = ref39_gleaner()
    load1 = ref39_nabu(harvest)
