...
@op
def cuahsi174_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi174")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi174_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi174")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi174():
    harvest = cuahsi174_gleaner()
    load1 = cuahsi174_nabu(harvest)
