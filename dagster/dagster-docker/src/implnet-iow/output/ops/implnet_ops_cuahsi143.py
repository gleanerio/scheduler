...
@op
def cuahsi143_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi143")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi143_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi143")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi143():
    harvest = cuahsi143_gleaner()
    load1 = cuahsi143_nabu(harvest)
