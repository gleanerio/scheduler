...
@op
def cuahsi107_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi107")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi107_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi107")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi107():
    harvest = cuahsi107_gleaner()
    load1 = cuahsi107_nabu(harvest)
