...
@op
def cuahsi140_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi140")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi140_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi140")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi140():
    harvest = cuahsi140_gleaner()
    load1 = cuahsi140_nabu(harvest)
