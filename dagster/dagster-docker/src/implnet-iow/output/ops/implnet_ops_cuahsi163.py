...
@op
def cuahsi163_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi163")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi163_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi163")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi163():
    harvest = cuahsi163_gleaner()
    load1 = cuahsi163_nabu(harvest)
