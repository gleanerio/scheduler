...
@op
def cuahsi156_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi156")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi156_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi156")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi156():
    harvest = cuahsi156_gleaner()
    load1 = cuahsi156_nabu(harvest)
