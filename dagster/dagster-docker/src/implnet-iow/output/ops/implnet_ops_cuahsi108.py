...
@op
def cuahsi108_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi108")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi108_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi108")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi108():
    harvest = cuahsi108_gleaner()
    load1 = cuahsi108_nabu(harvest)
