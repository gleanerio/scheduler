...
@op
def cuahsi136_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi136")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi136_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi136")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi136():
    harvest = cuahsi136_gleaner()
    load1 = cuahsi136_nabu(harvest)
