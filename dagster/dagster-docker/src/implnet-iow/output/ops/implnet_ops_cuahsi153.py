...
@op
def cuahsi153_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi153")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi153_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi153")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi153():
    harvest = cuahsi153_gleaner()
    load1 = cuahsi153_nabu(harvest)
