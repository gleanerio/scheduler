...
@op
def cuahsi157_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi157")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi157_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi157")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi157():
    harvest = cuahsi157_gleaner()
    load1 = cuahsi157_nabu(harvest)
