...
@op
def cuahsi177_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi177")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi177_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi177")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi177():
    harvest = cuahsi177_gleaner()
    load1 = cuahsi177_nabu(harvest)
