...
@op
def cuahsi151_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi151")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi151_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi151")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi151():
    harvest = cuahsi151_gleaner()
    load1 = cuahsi151_nabu(harvest)
