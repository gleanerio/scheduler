...
@op
def cuahsi115_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi115")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi115_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi115")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi115():
    harvest = cuahsi115_gleaner()
    load1 = cuahsi115_nabu(harvest)
