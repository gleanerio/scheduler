...
@op
def cuahsi142_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi142")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi142_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi142")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi142():
    harvest = cuahsi142_gleaner()
    load1 = cuahsi142_nabu(harvest)
