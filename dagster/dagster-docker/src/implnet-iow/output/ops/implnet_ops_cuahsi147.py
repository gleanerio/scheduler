...
@op
def cuahsi147_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi147")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi147_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi147")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi147():
    harvest = cuahsi147_gleaner()
    load1 = cuahsi147_nabu(harvest)
