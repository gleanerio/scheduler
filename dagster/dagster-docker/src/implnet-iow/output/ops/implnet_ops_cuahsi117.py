...
@op
def cuahsi117_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi117")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi117_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi117")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi117():
    harvest = cuahsi117_gleaner()
    load1 = cuahsi117_nabu(harvest)
