...
@op
def cuahsi152_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi152")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi152_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi152")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi152():
    harvest = cuahsi152_gleaner()
    load1 = cuahsi152_nabu(harvest)
