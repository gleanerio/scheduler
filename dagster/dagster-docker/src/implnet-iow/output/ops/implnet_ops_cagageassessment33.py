...
@op
def cagageassessment33_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cagageassessment33")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cagageassessment33_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cagageassessment33")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cagageassessment33():
    harvest = cagageassessment33_gleaner()
    load1 = cagageassessment33_nabu(harvest)
