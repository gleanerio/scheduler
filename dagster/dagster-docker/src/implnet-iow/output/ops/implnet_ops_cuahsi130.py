...
@op
def cuahsi130_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi130")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi130_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi130")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi130():
    harvest = cuahsi130_gleaner()
    load1 = cuahsi130_nabu(harvest)
