...
@op
def cuahsi173_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi173")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi173_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi173")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi173():
    harvest = cuahsi173_gleaner()
    load1 = cuahsi173_nabu(harvest)
