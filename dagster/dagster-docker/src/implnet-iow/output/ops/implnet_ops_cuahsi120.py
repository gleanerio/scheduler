...
@op
def cuahsi120_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi120")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi120_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi120")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi120():
    harvest = cuahsi120_gleaner()
    load1 = cuahsi120_nabu(harvest)
