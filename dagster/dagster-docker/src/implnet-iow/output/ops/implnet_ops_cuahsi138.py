...
@op
def cuahsi138_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi138")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi138_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi138")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi138():
    harvest = cuahsi138_gleaner()
    load1 = cuahsi138_nabu(harvest)
