...
@op
def cuahsi168_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi168")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi168_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi168")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi168():
    harvest = cuahsi168_gleaner()
    load1 = cuahsi168_nabu(harvest)
