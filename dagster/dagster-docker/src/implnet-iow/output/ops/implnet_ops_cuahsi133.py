...
@op
def cuahsi133_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi133")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi133_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi133")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi133():
    harvest = cuahsi133_gleaner()
    load1 = cuahsi133_nabu(harvest)
