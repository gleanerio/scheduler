...
@op
def cuahsi154_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi154")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi154_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi154")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi154():
    harvest = cuahsi154_gleaner()
    load1 = cuahsi154_nabu(harvest)
