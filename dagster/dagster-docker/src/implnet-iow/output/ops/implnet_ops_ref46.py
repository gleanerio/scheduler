...
@op
def ref46_gleaner(context):
    returned_value = gleanerio(("gleaner"), "ref46")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def ref46_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "ref46")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_ref46():
    harvest = ref46_gleaner()
    load1 = ref46_nabu(harvest)
