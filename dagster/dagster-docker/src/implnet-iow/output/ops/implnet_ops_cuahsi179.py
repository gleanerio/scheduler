...
@op
def cuahsi179_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi179")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi179_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi179")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi179():
    harvest = cuahsi179_gleaner()
    load1 = cuahsi179_nabu(harvest)
