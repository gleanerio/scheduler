...
@op
def cuahsi148_gleaner(context):
    returned_value = gleanerio(("gleaner"), "cuahsi148")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def cuahsi148_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "cuahsi148")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@graph
def harvest_cuahsi148():
    harvest = cuahsi148_gleaner()
    load1 = cuahsi148_nabu(harvest)
