...
def oceanscape_index(context):
    ...
    returned_value = subprocess.run('./gleaner.bin -cfg gleanerconfig.yaml  --source oceanscape', shell=True, cwd='/usr/src/app')
    # returned_value = subprocess.call('./gleanerDocker.sh -cfg /gleaner/wd/rundir/gleanerconfig.yaml  --source oceanscape', shell=True, cwd='/home/fils/src/gomods/gleaner/secret/dockercli')
